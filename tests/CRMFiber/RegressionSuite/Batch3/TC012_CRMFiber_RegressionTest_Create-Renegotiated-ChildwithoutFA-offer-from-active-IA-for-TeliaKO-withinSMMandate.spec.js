...
const TestCaseName = 'TC012_CRMFiber_RegressionTest';



test('TC012_CRMFiber_RegressionTest_Create-Renegotiated-ChildwithoutFA-offer-from-active-IA-for-TeliaKO-withinSMMandate', async function ({ browser }) {
