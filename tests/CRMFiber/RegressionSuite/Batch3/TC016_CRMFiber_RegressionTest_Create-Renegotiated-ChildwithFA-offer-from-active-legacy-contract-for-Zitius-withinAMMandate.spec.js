...
const TestCaseName = 'TC016_CRMFiber_RegressionTest';



test('TC016_CRMFiber_RegressionTest_Create-Renegotiated-ChildwithFA-offer-from-active-legacy-contract-for-Zitius-withinAMMandate', async function ({ browser }) {
  ...
  await faCartPage.verifyExistingFAProductPricingLogicOnChildFA(LocalTestData);
