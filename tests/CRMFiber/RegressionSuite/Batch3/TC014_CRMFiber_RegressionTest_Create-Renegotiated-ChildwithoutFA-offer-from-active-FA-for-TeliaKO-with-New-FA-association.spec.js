...
const TestCaseName = 'TC014_CRMFiber_RegressionTest';



test('TC014_CRMFiber_RegressionTest_Create-Renegotiated-ChildwithoutFA-offer-from-active-FA-for-TeliaKO-withinSMMandate-with-New-FA-association', async function ({ browser }) {
