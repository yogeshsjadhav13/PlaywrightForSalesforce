...
const TestCaseName = 'TC011_CRMFiber_RegressionTest';



test('TC011_CRMFiber_RegressionTest_Create-Renegotiated-ChildwithFA-offer-from-active-IA-for-TeliaKO-withinAMMandate-with-New-Product-addition-from-FA', async function ({ browser }) {
  ...
  LocalTestData.set("QuoteRecordType", "Offert - Standard");
  LocalTestData.set("QuoteRecordTypeName", "Offert - Standard");
  ...
  await faCartPage.VerifyCRMFiberProductIsNotVisibleInTheCart(LocalTestData);
