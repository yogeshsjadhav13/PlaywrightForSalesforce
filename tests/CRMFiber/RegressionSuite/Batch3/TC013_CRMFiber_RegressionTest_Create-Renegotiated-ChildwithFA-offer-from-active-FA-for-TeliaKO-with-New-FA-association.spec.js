...
const TestCaseName = 'TC013_CRMFiber_RegressionTest';



test('TC013_CRMFiber_RegressionTest_Create-Renegotiated-ChildwithFA-offer-from-active-FA-for-TeliaKO-withinAMMandate-with-New-FA-association', async function ({ browser }) {
