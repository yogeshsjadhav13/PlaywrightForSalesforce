...
const TestCaseName = 'TC015_CRMFiber_RegressionTest';



test('TC015_CRMFiber_RegressionTest_Create-Renegotiated-IA-contract-from-active-legacy-contract-for-TeliaKO-withinAMMandate', async function ({ browser }) {
