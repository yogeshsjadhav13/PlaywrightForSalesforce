...
const TestCaseName = 'TC010_CRMFiber_RegressionTest';



test('TC010_CRMFiber_RegressionTest_Create-IA-active-contract-for-TeliaKO-withinSMMandate-with-TeliaMDUSDUKundagtNat-XLAN-document', async function ({ browser }) {
  ...
  //Step 13 - Perform full Skapa orderunderlag functionality
  LocalTestData.set("OrderunderlagType", "FullOrderunderlag");
  //await contractPage.verifyCRMFiberOrderunderlagFunctionality(LocalTestData, utilityFunctionLocal);
