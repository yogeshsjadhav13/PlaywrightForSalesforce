...
const TestCaseName = 'TC005_CRMFiber_RegressionTest';



test('TC005_CRMFiber_RegressionTest_Create-FA-active-contract-for-TeliaKO-withinAMMandate-and-Renegotiate-and-Terminate', async function ({ browser }) {
