...
const TestCaseName = 'TC001_CRMFiber_RegressionTest';


test('TC001_CRMFiber_RegressionTest_SOHO_NewSales-Verify-quote-contract-document', async function ({ browser }) {
...
Avtal för Mekonomen Billivet Borås AB 

Tv, streaming och bredband i ett nät av världsklass.

Telia Öppen Fiber

Med Telia Öppen Fiber får ni tillgång till en supersnabb, stabil och framtidssäkrad bredbandsanslutning. Fastigheten ansluts till ett av Sveriges mest kraftfulla fibernät som levererar tjänster i världsklass för tv, streaming och bredband.
...
Kollektivt Bredband - 500 Mbit/s

 7 st

0.00 kr

204.00 kr per anslutning 
...
320.00 kr per anslutning 





Installationsavgift för Fastighetstyrningsport
...
Fastighetsstyrning WAN 100 Mbit/s i Accesswitch

 7 st

0.00 kr

728.00 kr per anslutning 





Fastighetsstyrning EXTRA 100 Mbit/s i Accesswitch
...
Telias avtalsnummer
 ...
 Mekonomen Billivet Borås AB (nedan kallad ”Fastighetsägaren”)
...
Fastighetsägaren och Telia har genom detta Avtal överenskommit att Telia ska avseende Fastighet(er) (om fler så nedan gemensamt benämnda ”Fastigheten”) som anges i ”Bilaga: Fastighetsbeteckningar”, ansluta befintligt Fastighetsnät och Kundplacerad Utrustning till Telias Nät enligt närmare beskrivning i ”Bilaga: Installation”.

Antal anslutningar i Telias Nät ska uppgå till 400 st. varav 400 st. befintliga och 0 st. tillkommande. Telia kan erbjuda anslutning av ytterligare Bostäder/Lokaler till Telias Nät enligt särskild offert efter förfrågan från Fastighetsägaren.    

Parterna är överens om att Telia ska ansluta Fastighetsnätet till Telias Nät genom Öppen Fiber. Inom Öppen Fiber möjliggör Telia för Tjänsteleverantörer att tillhandahålla Bredbandstjänster till Bostäder/Lokaler anslutna till Fastighetsnätet. Boende/Företag på Fastigheten tecknar individuellt avtal med valfri tjänsteleverantör vid var tid aktuella Bredbandstjänster. Tjänsteleverantörer som finns tillgängliga i Öppen Fiber framgår av www.bredbandswebben.se. Utbudet av Tjänsteleverantörer, tjänster och priser kan förändras över tid samt ha lokala avvikelser. 
...
Förekommer mot varandra stridande villkor i Avtalet gäller villkoren i denna huvudtext före villkoren i bilagor och bilagorna sinsemellan i nummerordning. Senare tillkomna bilagor ska gälla före äldre bilagor av samma typ.
...
Anslutning av befintligt Fastighetsnät till Telias Nät i enlighet med ”Bilaga: Installation”. Antal anslutna Bostäder/Lokaler uppgår till 111 st. och antal Övriga portar uppgår till 0 st. varav antal Tillkommande portar uppgår till 0 st. För anslutning till Telias Nät utgår en engångsavgift om 2800.00 kr exklusive moms (avser befintliga anslutningar). 

Priset för de kollektiva tjänsterna ska faktureras successivt i takt med att Bredbandstjänsterna aktiveras i respektive Fastighet. Tjänsterna ska aktiveras i etapper enligt vad som närmare framgår av ”Bilaga: Fastighetsbeteckningar”.  

Installationshjälp till Boende avseende kollektiva tjänster från Telia i enlighet med ”Bilaga: Installationshjälp”. 

För fastighetsstyrning ansluts 21 st. portar.

Boende på Fastigheten i Bostad får tillgång till Bredbandstjänster genom kollektiv anslutning enligt nedan. För undvikande av missförstånd noteras att Lokaler aldrig ansluts till Tv från Telia. För kollektiva tjänster utgår en månadsavgift om 1414.00 kr/mån per Bostad. Fakturering av Fastighetsägaren sker kvartalsvis.

Kollektivt Bredband - 100 Mbit/s levereras till 7 st. anslutningar. 

Kollektivt Bredband - 500 Mbit/s levereras till 7 st. anslutningar. 

Kollektivt Bredband - 1000 Mbit/s levereras till 111 st. anslutningar. 
...
Telia Telefoni levereras till 111 st. anslutningar. Parterna är överens om att samtalskostnader inte ingår i priset för den kollektiva tjänsten och att Boende ska betala ersättning till Telia för samtalskostnader enligt Telias vid var tid gällande prislista.
...
Företag på Fastigheten i Lokal får tillgång till Bredbandstjänster genom kollektiv anslutning enligt nedan. För undvikande av missförstånd noteras att Företagslokaler aldrig ansluts till Tv från Telia. För kollektiva tjänster utgår en månadsavgift om 363.00 kr/mån per Lokal. Fakturering av Fastighetsägaren sker kvartalsvis. 

Telia Kollektivt Bredband Företag Start - 100/100 Mbit/s levereras till 7 st.    
...
Bostad är Boendes privatbostad i Flerfamiljshus, lokal som disponeras av näringsidkare eller annan lokal som är belägen på Fastigheten.
...
Kundplacerad Utrustning är utrustning (inklusive programvara), som ägs eller tillhandahålls av Telia och som placeras på Fastigheten för att möjliggöra tillhandahållandet av Bredbandstjänster till Företag. Utrustning placerad hos Slutkund som ett resultat av individuellt avtal omfattas inte av denna definition.

Lokal är lokal som disponeras av näringsidkare eller annan lokal som är belägen på Fastigheten.
...
Nätfel är avvikelse som medför att samtliga Slutkunder anslutna till en Access-switch är drabbade av Fel. 
...
Denna bilaga kompletteras av bestämmelserna i ”Bilaga: Allmänna villkor för Telia Fastighetsanslutning”.
...
Kravspecifikation Telia Fastighetsanslutning, Telia Öppen Fiber (FTTH & FTTB)

Detta dokument beskriver Telias kravspecifikation för byggnation samt installation av FTTH & FTTB nät för produkterna Telia Fastighetanslutning och Telia Öppen Fiber.
...
Fastighetsnät FTTB består av koppar in i Bostaden respektive Enfamiljshus. 
...
Serviceansvar för Telia Fastighetsanslutning, Telia Öppen Fiber (FTTH & FTTB) 

Detta dokument beskriver Telias respektive Fastighetsägarens Serviceansvar för det fall Parterna ingått avtal om Telia Fastighetanslutning eller Telia Öppen Fiber.
...
Tjänstespecifik hårdvara regleras avseende ägande och Serviceansvar beroende av kollektivt eller individuellt avtal med Tjänsteleverantör. I kollektiva avtal äger Fastighetsägaren tv-box, trådlös router, Telia har Serviceansvar under avtalstid. För individuella avtal gäller ägande och serviceansvar enligt avtal mellan Slutkund och Tjänsteleverantör.

I de fall Tjänstespecifik hårdvara tillhandahålls från Telia ansvarar Fastighetsägaren för att det finns en lämplig yta att placera denna på i respektive Bostad/Lokal. För de fall teknikskåp har byggts ansvarar Fastighetsägaren för att detta är byggt i ett material som wifi-signal kan ta sig igenom och inte, till exempel i metall.
...
Tjänsteleverantör, Fastighetsägare, Slutkund
...
Tjänsteleverantör, Slutkund, Fastighetsägare
...
Tjänsteleverantör felsöker och åtgärdar vid behov sin tjänsteplattform, samt kontrollerar att Slutkundens inkoppling till Bredbandstjänsten är korrekt och att Felet inte finns i Slutkundens egen utrustning eller handhavande av Bredbandstjänsten. 
...
1.1	Dessa allmänna villkor gäller då Telia till en Fastighetsägare möjliggör anslutning av Fastighetsnät för Bostäder/Lokaler till Telias Nät. Efter överenskommelse kan Telia även tillhandahålla andra tjänster, såsom installation av Fastighetsnät, service av Fastighetsnät, Telias Bredbandstjänster genom kollektiv anslutning till Boende/Företag på aktuella Fastigheter eller anslutning till Öppen Fiber. De tjänster som tillhandahålls specificeras i Avtalet.

1.2	Avtalet reglerar inte tillhandahållande av Bredbandstjänster i relationen direkt till Boende/Företag. Boende/Företaget kan få tillgång till Bredbandstjänst kollektivt via Fastighetsägaren eller individuellt genom att teckna ett särskilt avtal om Bredbandstjänst med en Tjänsteleverantör.

1.3	Boende/Företag som får möjlighet att tillgå Bredbandstjänst kollektivt från Telia genom Fastighetsägaren måste aktivera Bredbandstjänsten för att ta del av den. Bredbandstjänsten aktiveras genom att Boenden/Företaget kontaktar Telia och uppger namn, adress och eventuell e-postadress. Genom att aktivera Bredbandstjänsten ingår Boenden/Företaget särskilt avtal med Telia om Bredbandstjänsten.

2.	Telias åtaganden 

2.1	Telia ska tillhandahålla aktuella tjänster på ett fackmässigt sätt i överensstämmelse med Avtalet.

2.2	Telia har rätt att anlita underleverantörer för att fullgöra sina åtaganden enligt Avtalet. Telia svarar i så fall för underleverantörens arbete såsom för eget arbete

2.3	Vid anslutning till Telias Nät av Fastighetsnät i befintlig bebyggelse ska anslutningen ske vid den tidpunkt som skriftligen överenskommits mellan Parterna. Telia ansvarar för leverans av kabel fram till Nätanslutningspunkten.

2.4	Vid fel i markförlagd kabel fram till Nätanslutningspunkten ansvarar Telia för schaktning, felrättning och återfyllnad under förutsättning att felet inte har förorsakats av Fastighetsägaren, någon som Fastighetsägaren svarar för, Boende, Företag eller besökare till Boenden eller Företaget. Innan grävning påbörjas inom Fastighet kontaktas Fastighetsägaren för samråd om det praktiska utförandet. 

2.5	Om Telias Bredbandstjänst tillhandahålls till Boende eller Företag kollektivt via Fastighetsägaren har Telia rätt att stänga eller begränsa Bredbandstjänsten för en eller flera Boenden eller Företag i den utsträckning som anges i Telias allmänna villkor för elektroniska kommunikationstjänster till företag samt Telias allmänna villkor för tjänster till konsument vid motsvarande förhållanden som där anges, oavsett om detta har sin grund i handlande eller underlåtenhet från Fastighetsägarens eller från Boendens/Företagets sida.

3.	Fastighetsägarens åtaganden

3.1	Fastighetsägaren ska på egen bekostnad bereda Telia tillträde till Fastigheten. Med avseende på byggnation, installation och/eller anslutning av Fastighetsnät ska Telia ges tillträde skyndsamt och utan vidare dröjsmål. Med avseende på service ska Telia ges tillträde i enlighet med vad som framgår av Avtalet. Telia ska beredas fri framkomlighet där arbeten ska utföras. Flytt av möbler och liknande omfattas inte av Telias åtaganden. Fastighetsägaren ska vidare förse Telia med lista över kontaktpersoner avseende tillträde till Fastigheten.

3.2	Fastighetsägaren ansvarar för att eventuellt bygglov och andra myndighetstillstånd som avser Fastigheten i förekommande fall införskaffas för anläggning av det som ska installeras. Motsvarande gäller om Fastighetsnät ägs av annan än Fastighetsägaren och Telia behöver tillstånd från ägaren av nätet för att kunna utföra sina åtaganden enligt Avtalet. Fastighetsägaren ska bereda Telia nödvändigt bistånd och står för kostnaden nämnda sådant tillstånd. Om tillstånd inte medges, har Telia rätt att med omedelbar verkan frånträda Avtalet.

3.3	Fastighetsägaren ansvarar för att Fastighetsnätet uppfyller de krav som anges i bilagan Kravspecifikation liksom i Avtalet i övrigt för att anslutning ska kunna ske, t.ex. att teknikutrymmen, eluttag, kanalisation mellan Nätanslutningspunkt och i förekommande fall Fastighetsnät, är etablerat innan anslutning påbörjas. Fastighetsägaren ansvarar för att nödvändig kanalisation förläggs på riktigt sätt. Vid Intag ovan mark ansvarar Fastighetsägaren för att kabeln skyddas från åverkan. För Fastighetsnät som ska användas för tillhandahållande av Kabel-tv ansvarar Fastighetsägaren särskilt för att Fastighetsnätet uppfyller den standard som anges i Avtalet. 

3.4	Fastighetsägaren ansvarar för drift och underhåll av Fastighetsnät och att sådant nät kontinuerligt uppfyller de krav som anges i Avtalet. Fastighetsägaren ansvarar för att utan oskäligt dröjsmål avhjälpa fel i Fastighetsnät. Om Parterna har avtalat att Telia ska tillhandahålla service av Fastighetsnät m.m. ska härutöver avsnitt 4 tillämpas.

3.5	Fastighetsägaren ansvarar för att el finns framdragen till Kundplacerad Utrustning senast den dag Parterna avtalat att installation av Fastighetsnät ska vara färdigställd. Om så inte sker, har Telia rätt att själv eller genom underleverantör företa sådan framdragning av el på Fastighetsägarens bekostnad. Fastighetsägaren ansvarar vidare för den strömförbrukning som är nödvändig för driften av Kundplacerad Utrustning.

3.6	Fastighetsägaren står risken för skada på eller förlust av Kundplacerad Utrustning från den tidpunkt då den Kundplacerade Utrustningen installerats. Kundplacerad Utrustning får inte utan Telias skriftliga medgivande flyttas från den plats där den installerats.

3.7	Fastighetsägaren får inte utan Telias skriftliga medgivande reparera, utföra service på, göra påbyggnader på eller ändringar i, eller ta bort delar eller märkning avseende ägandeförhållanden från Kundplacerad Utrustning. Fastighetsägaren ska följa de anvisningar som Telia från tid till annan utfärdar beträffande skötsel och användning av Kundplacerad Utrustning. Fastighetsägaren ansvarar vidare för att förhindra att obehörig person ges tillgång till Kundplacerad Utrustning och Fastighetsägaren ska omedelbart meddela Telia om så ändå sker.

3.8	Fastighetsägaren ska vidta alla rimliga åtgärder för att säkerställa att inte Boende/Företag eller annan vidtar åtgärder som medför störningar för Fastighetsnätet och Kundplacerad Utrustning. Fastighetsägaren svarar även för att utan oskäligt dröjsmål stoppa sådana störningar.

4.	Installation av Fastighetsnät

4.1	Om Parterna överenskommit att Avtalet ska omfatta även installation av Fastighetsnät, gäller punkterna 4.2 – 4.5 nedan. Installation av Fastighetsnät omfattar anläggande av kabel och i förekommande fall kanalisation, inklusive nödvändiga anslutningar och uttag i byggnad på det sätt som anges i Avtalet.

4.2	Telia kallar Fastighetsägaren till ett startmöte i syfte att gå igenom installationsprocessen och andra relevanta frågor. Respektive Part ska utse var sin kontaktman för att ansvara och hantera löpande frågor rörande installationen. Vardera Parten ska bära sina respektive kostnader för startmötet. På startmötet ska Parterna överenskomma om detaljerad tidplan och former för arbetets utförande.

4.3	I god tid innan installationen påbörjas och senast vid startmötet ska Fastighetsägaren förse Telia med fastighetsbeskrivning, ritningar över Fastigheten och berörda byggnader utvisande nödvändig information för anslutning och installation. Fastighetsägaren ansvarar för att sådan information är korrekt och fullständig.

4.4	Installation och/eller anslutning av Fastighetsnät i såväl nybyggnation av byggnad som i befintlig bebyggelse ska ske vid den tidpunkt som skriftligen överenskommits mellan Parterna.

4.5	Fastighetsägaren ansvarar för kanalisation från tomtgränsen fram till Nätanslutningspunkten.

5.	Ersättning 

5.1	Fastighetsägaren ska betala i Avtalet överenskommen ersättning. Samtliga priser är exklusive mervärdesskatt. Fakturaavgift tillkommer för pappersfaktura.

5.2	Fastighetsägaren ska betala faktura inom trettio (30) dagar från fakturadatum i enlighet med anvisningar angivna på fakturan. Vid förskottsbetalning enligt punkt 5.5 ska betalning ske senast den dag Telia anger.

5.3	Debitering av i Avtalet ingående tjänster påbörjas vid tidpunkt som Parterna överenskommit i Avtalet eller annars på avtalad leveransdag eller, om leveransen är försenad av orsak enbart hänförlig till Telia, från den dag då leverans faktiskt sker.

5.4	Om Fastighetsägaren inte fullgjort betalningen senast på förfallodagen har Telia rätt till ersättning för betalningspåminnelser och inkassokostnader samt till dröjsmålsränta enligt lag. Om Fastighetsägaren, trots påminnelse och stängning av Tjänsten inte betalar förfallen faktura, ska övrig ersättning för Tjänsten som ännu inte har fakturerats anses förfallen till omedelbar betalning.

5.5	Telia har rätt att under avtalstiden begära förskottsbetalning eller att Fastighetsägaren ställer säkerhet för Avtalets rätta fullgörande om det till följd av kreditprövning framstår som befogat. Ränta utgår inte på förskotterat belopp. Telia har vidare rätt att ur förskotterat belopp eller ställd säkerhet tillgodogöra sig belopp motsvarande sina förfallna fordringar, inklusive sådana kostnader som avses i punkt 5.4.

5.6	Telia har rätt att överlåta sin rätt till betalning enligt Avtalet till annan.

5.7	Bestämmelserna i detta avsnitt 5 ska äga motsvarande tillämpning för det fall Fastighetsägaren inom ramen för avtalet tillhandahåller tjänster till Telia.

6.	Äganderätt och nyttjanderätt

6.1	Om inte annat anges ska Fastighetsägaren inneha äganderätten till Fastighetsnätet och tillhörande Kanalisation.

6.2	Telias Nät ägs eller disponeras av bolag inom Telia-koncernen fram till och med Nätanslutningspunkten. Nätanslutningspunkten kan vara placerad vid fastighetsgränsen eller inne på Fastigheten. Om Nätanslutningspunkten är placerad inne på Fastigheten åtar sig Fastighetsägaren att på begäran av sådant Telia bolag teckna ett särskilt upplåtelseavtal i enlighet med särskild bilaga avseende rätt för bolaget att anlägga och bibehålla nät fram till och med Nätanslutningspunkten på Fastigheten samt i förekommande fall på gator, enskilt ägda fastigheter, etc. inom det område som omfattas av Avtalet.

6.3	Kundplacerad Utrustning, t.ex. Telias Access-switch, ägs av Telia som svarar för drift och underhåll av denna utrustning. Ägande och ansvar för annan utrustning som Telia installerat i Bostad/Lokal framgår av Avtalet. Telia förbehåller sig rätten att utföra konfigurationsändringar, uppgraderingar samt i övrigt disponera den Kundplacerade Utrustningen för utveckling av tjänster under den tid som utrustningen är ansluten mot Bredbandstjänst. Under omständighet att den Kundplacerade Utrustningen inte ägs av Telia, förbehåller sig Telia likväl rätten att utföra konfigurationsändringar, uppgraderingar samt i övrigt disponera sådan utrustning för utveckling av tjänster under den tid som utrustningen är ansluten mot Bredbandstjänst.

6.4	Fastighetsägaren ger Telia rätt att i den omfattning som behövs bygga ut Telias Nät inom Fastigheten fram till Nätanslutningspunkten.

6.5	Fastighetsägaren ger Telia rätt att under avtalstiden utan ersättning nyttja Fastighetens Teknikutrymme inklusive elektricitet, värme och kyla.

6.6	Avtalet innebär inte att äganderätten till Kundplacerad Utrustning övergår till Fastighetsägaren och Fastighetsägaren får inte sälja, pantsätta, hyra eller låna ut eller på annat sätt förfoga över sådan utrustning utan att Telia först lämnat skriftligt medgivande därtill.

6.7	Fastighetsägaren ska under avtalstiden tillförsäkra Telia en exklusiv nyttjanderätt till Fastighetsnätet och Kanalisationen för tillhandahållande av Bredbandstjänster.
...
7.2	Fastighetsägaren garanterar att denne vid överlåtelse av Fastigheten ska göra förbehåll för de nyttjanderätter och andra rättigheter som upplåts till Telia eller annat Telia bolag enligt Avtalet, så att Avtalet gäller mot förvärvare av Fastigheten. Fastighetsägaren ska vid överlåtelse av Fastigheten överlåta sina rättigheter och skyldigheter enligt Avtalet till förvärvare av Fastigheten.

7.3	Vad som sägs i punkt 7.2 ska gälla även vid annan fastighetsrättslig reglering eller vid överlåtelse av Fastighetsnätet eller del därav.

8.	Förtida upphörande

8.1	Vardera Parten får säga upp Avtalet med omedelbar verkan om: den andra Parten inleder likvidationsförhandlingar, inger ansökan om företagsrekonstruktion, inleder ackord, försätts i konkurs eller eljest kan antas vara på obestånd, eller; den andra Parten har gjort sig skyldig till väsentligt avtalsbrott som inte åtgärdats inom tio (10) arbetsdagar efter skriftlig begäran.

8.2	Uppsägning enligt punkt 8.1 ska ske skriftligen.

8.3	Definitionerna i Avtalets Bilaga 1 samt bestämmelserna i dessa Allmänna villkor punkterna 3.4 - 3.6, 7.1 – 7.3, 9.1 – 9.4, 10.1 - 10.3, 11.1 – 11.3 samt 13.1 – 13.3 ska äga fortsatt giltighet även efter Avtalets upphörande till dess Telias avtal med Boende/Företaget om Bredbandstjänst upphört att gälla.

9.	Skadestånd

9.1	Part har rätt till ersättning för direkt skada som motparten, eller någon för vilken motparten svarar, förorsakat genom vårdslöshet. Part har inte någon rätt till ersättning för indirekta skador, såsom utebliven handelsvinst, kostnader som blivit onyttiga eller andra följdskador. Parts ansvar är vidare för varje skadetillfälle begränsat till ett sammanlagt belopp motsvarande trettiofem (35) prisbasbelopp enligt lagen (1962:381) om allmän försäkring, om inte annat anges i Avtalet.

9.2	Oaktat vad som föreskrivs i punkt 9.1 ovan ansvarar Telia inte för skada som uppkommer för Fastighetsägaren till följd av innehåll i data eller annan information som förmedlas vid användning av tjänster enligt Avtalet, inte heller ansvarar Telia för skada orsakad av datavirus eller motsvarande, försening, förvanskning eller förlust av data eller för Fastighetsägaren eventuella ersättningsskyldighet gentemot tredje man.

9.3	Begränsningarna av Parts skadeståndsskyldighet gäller inte i fall av uppsåt eller grov vårdslöshet, vid personskada eller vid sådant ansvar som följer av tvingande lag. Begränsningarna av Parts skadeståndsskyldighet gäller vidare inte vid skada som uppkommit till följd av att Fastighetsägaren brutit mot punkt 7.2 eller 7.3.

9.4	Begäran om skadestånd skall, för att kunna göras gällande, framställas skriftligen senast två (2) månader efter det att felet, förseningen eller skadan upptäckts eller bort upptäckas.
...
10.2	Såsom Befriande Omständighet ska anses bland annat myndighetsåtgärd eller underlåtenhet, nytillkommen eller ändrad lagstiftning, arbetskonflikt, blockad, krig, upplopp, sabotage, extrema väderförhållanden, blixtnedslag, brand, explosion, översvämning, naturkatastrof, olyckshändelse eller kabelbrott som orsakats av tredje man.

10.3	Part som påkallar befrielse enligt punkt 10.1 ska utan dröjsmål underrätta andra Parten därom. Befrielsegrund anses föreligga så länge Befriande Omständighet utgör hinder för fullgörande, dock högst tre (3) månader. Därefter har vardera Parten rätt att frånträda Avtalet utan att några påföljder på grund av detta kan göras av den andra Parten.

11.	Sekretess

11.1	Part förbinder sig att inte för tredje man avslöja Konfidentiell Information, vilken Part erhåller eller erhållit från den andra Parten. Med "Konfidentiell Information" avses varje upplysning - teknisk, kommersiell eller av annan art, förutsatt att sådan information rimligen kan anses vara av konfidentiell natur, oavsett om upplysningen dokumenteras eller inte - med undantag för:
...
11.5	Bestämmelserna i punkt 11.1 innebär inte hinder för Part att lämna ut Konfidentiell Information när sådant erfordras på grund av bestämmelse i lag eller på grund av domstols eller myndighetsbeslut.

11.6	Telia får lämna ut Konfidentiell Information till annat bolag inom Teliakoncernen. Därutöver får den Part som mottar Konfidentiell Information lämna ut informationen endast till sådana anställda, styrelseledamöter, konsulter och underleverantörer som behöver tillgång till informationen för att Avtalet ska kunna fullföljas. Mottagande Part ansvarar för att sådana personer före sådant utlämnande är medvetna om och följer bestämmelserna i Avtalet.

12.	Övrigt

12.1	Ändringar av eller tillägg till Avtalet ska för att vara bindande vara skriftligen avfattade och undertecknade av Parterna.

12.2	Avtalet utgör Parternas fullständiga reglering av alla frågor som Avtalet berör. Alla skriftliga eller muntliga överenskommelser, åtaganden eller utfästelser som föregått Avtalet ska ersättas av innehållet i Avtalet.

12.3	I Avtalet angivna priser och överenskomna leveranstider förutsätter att dels de faktiska omständigheterna rörande Fastigheten överensstämmer med vad Fastighetsägaren uppgivit senast i samband med Avtalets ingående, dels att installations- och anslutningsarbetena inte i övrigt stöter på hinder som inte skäligen kunde förutses av Telia vid Avtalets ingående. I annat fall har Telia rätt till ersättning från Fastighetsägaren för eventuella tillkommande kostnader.

12.4	Telia utvecklar fortlöpande sina tjänster och tekniska plattformar. Telia äger rätt att ändra eller modifiera tjänsterna som levereras under detta Avtal, inklusive tekniska plattformar, under förutsättning att tjänsternas prestanda eller funktionalitet därmed inte försämras. Sådan ändring eller modifiering ska utföras på ett sådant sätt att eventuella störningar begränsas.

13.	Tillämplig lag och tvist

13.1	Parternas rättigheter och skyldigheter vid tolkning och tillämpning av Avtalet ska bestämmas i enlighet med svensk lag.

13.2	Tvist i anledning av Avtalet ska slutligt avgöras i Stockholm genom skiljedom vid Stockholms Handelskammares Skiljedomsinstitut (”Institutet”).

13.3	Institutets Regler för Förenklat Skiljeförfarande ska gälla om inte Institutet med beaktande av målets svårighetsgrad, tvisteföremålets värde eller övriga omständigheter bestämmer att Reglerna för Stockholms Handelskammares Skiljedomsinstitut ska tillämpas på förfarandet. I sistnämnda fall ska Institutet också bestämma om skiljenämnden ska bestå av en eller tre skiljemän. Oaktat vad ovan anges har Part rätt att vända sig till svensk domstol eller annan behörig myndighet om tvistigt kapitalbelopp inte överstiger etthundratusen (100 000) EUR.`;
...
2 (30)
Telia Öppen Fiber
Med Telia Öppen Fiber får ni tillgång till en supersnabb, stabil och framtidssäkrad 
bredbandsanslutning. Fastigheten ansluts till ett av Sveriges mest kraftfulla fibernät som levererar 
...
vad som krävs för att ert fibernät ska hålla i decennier framöver. Vi säkerställer drift och funktionalitet 
av nätet dygnet runt och felsöker proaktivt för att snabbt åtgärda eventuella fel. Dessutom har vi en 
egen kundtjänst för er som Fastighetsägare dit ni kan vända er med alla frågor som rör 
fiberanslutningen.
Följande ingår i denna offert: 
Vi ansluter befintligt Fastighetsnät till Telias Nät.
...
Antal portar
Totalt antal Bostäder111 st
Totalt antal Lokaler0 st
Totalt antal Övriga portar0 st
Totalt antal 
anslutningar111 st
Produkter
Kollektiv Installationshjälp 111 st0.00 kr0.00 kr per anslutning
Kollektiv hårdvara - Trådlös 
Router 7 st0.00 kr0.00 kr per anslutning
Kollektiv hårdvara - Tv-box 111 st0.00 kr0.00 kr per anslutning
Kollektiv Telefoni 111 st0.00 kr0.00 kr per anslutning
Kollektiv TV - Stor 7 st0.00 kr
167.00 kr per 
anslutning 
...
Kollektiv Installationshjälp 111 st0.00 kr0.00 kr per anslutning
Kollektiv hårdvara - Trådlös 
Router 111 st0.00 kr0.00 kr per anslutning
Kollektiv hårdvara - Tv-box 111 st0.00 kr0.00 kr per anslutning
Kollektiv Telefoni 7 st0.00 kr0.00 kr per anslutning
Kollektiv Tv & Streaming 
Start 111 st0.00 kr8.00 kr per anslutning
Kollektivt Bredband - 500 
Mbit/s 7 st0.00 kr
204.00 kr per 
anslutning 
Kollektiv Installationshjälp 111 st0.00 kr0.00 kr per anslutning
...
Mbit/s 111 st0.00 kr
320.00 kr per 
anslutning 
Installationsavgift för 
Fastighetstyrningsport 7 st400.00 kr0.00 kr per anslutning
Fastighetsstyrning WAN 100 
Mbit/s i Accesswitch 7 st0.00 kr
728.00 kr per 
anslutning 
Fastighetsstyrning EXTRA 
100 Mbit/s i Accesswitch 7 st0.00 kr
728.00 kr per 
anslutning 
Kollektivt Bredband Företag 
Start - 100/100 Mbit/s 7 st0.00 kr
363.00 kr per 
anslutning 
Kollektivt Bredband - 500 
Mbit/s 7 st0.00 kr
...
146.00 kr per 
anslutning 
Summa2800.00 kr57575.00 kr
UPPKOPPLING UTAN KRÅNGELSAMMANSTÄLLNING
TOTAL ENGÅNGSAVGIFT
2800.00 kr (exkl moms)       
TOTAL MÅNADSAVGIFT
57575.00 kr/mån (exkl 
moms)
...
jämte eventuella tilläggsavtal till Ursprungsavtalet upphör att gälla och ersätts av detta Avtal i 
och med Telias driftsättning av tjänsterna enligt detta Avtal. 
Fastighetsägaren och Telia har genom detta Avtal överenskommit att Telia ska avseende 
Fastighet(er) (om fler så nedan gemensamt benämnda ”Fastigheten”) som anges i ”Bilaga: 
Fastighetsbeteckningar”, ansluta befintligt Fastighetsnät och Kundplacerad Utrustning till 
Telias Nät enligt närmare beskrivning i ”Bilaga: Installation”.
Antal anslutningar i Telias Nät ska uppgå till 400 st. varav  st. befintliga och 0 st. tillkommande.
Telia kan erbjuda anslutning av ytterligare Bostäder/Lokaler till Telias Nät enligt särskild offert 
efter förfrågan från Fastighetsägaren.  
Parterna är överens om att Telia ska ansluta Fastighetsnätet till Telias Nät genom Öppen 
Fiber. Inom Öppen Fiber möjliggör Telia för Tjänsteleverantörer att tillhandahålla 
Bredbandstjänster till Bostäder/Lokaler anslutna till Fastighetsnätet. Boende/Företag på 
Fastigheten tecknar individuellt avtal med valfri tjänsteleverantör vid var tid aktuella 
Bredbandstjänster. Tjänsteleverantörer som finns tillgängliga i Öppen Fiber framgår av 
www.bredbandswebben.se. Utbudet av Tjänsteleverantörer, tjänster och priser kan förändras 
över tid samt ha lokala avvikelser. 
...
Parternas respektive ansvar för service av Fastighetsnät m.m. framgår av ”Bilaga: Service”.
Telia är inte skyldigt att erbjuda anslutning av Fastighet, Fastighetsnät och/eller Områdesnät 
till Telias Nät om Telias kostnad för sådan anslutning skulle bli oskäligt hög i förhållande till 
nyttan av investeringen för Telia. Det sagda gäller exempelvis i de fall, men inte begränsat till, 
det endast finns ett fåtal Bostäder/Lokaler på Fastigheten. 
Förekommer mot varandra stridande villkor i Avtalet gäller villkoren i denna huvudtext före 
villkoren i bilagor och bilagorna sinsemellan i nummerordning. Senare tillkomna bilagor ska 
gälla före äldre bilagor av samma typ.
...
Telias avtalsnummer
 ...
 Stjärntorget 1
 169 94, Solna
 Mekonomen Billivet Borås AB (nedan kallad 
”Fastighetsägaren”)
 Org.nr 5591498570
 Box 14056, C/O Mekonomen Detaljist Ab
 20024, Malmö
...
anslutna Bostäder/Lokaler uppgår till 111 st. och antal Övriga portar uppgår till 0 st. varav 
antal Tillkommande portar uppgår till 0 st. För anslutning till Telias Nät utgår en engångsavgift 
om 2800.00 kr exklusive moms (avser befintliga anslutningar). 
Priset för de kollektiva tjänsterna ska faktureras successivt i takt med att Bredbandstjänsterna 
aktiveras i respektive Fastighet. Tjänsterna ska aktiveras i etapper enligt vad som närmare 
framgår av ”Bilaga: Fastighetsbeteckningar”. 
Installationshjälp till Boende avseende kollektiva tjänster från Telia i enlighet med ”Bilaga: 
Installationshjälp”. 
För fastighetsstyrning ansluts 21 st. portar.
Boende på Fastigheten i Bostad får tillgång till Bredbandstjänster genom kollektiv anslutning 
enligt nedan. För undvikande av missförstånd noteras att Lokaler aldrig ansluts till Tv från 
Telia. För kollektiva tjänster utgår en månadsavgift om 1414.00 kr/mån per Bostad. 
Fakturering av Fastighetsägaren sker kvartalsvis.
a.Kollektivt Bredband - 100 Mbit/s levereras till 7 st. anslutningar. 
b.Kollektivt Bredband - 500 Mbit/s levereras till 7 st. anslutningar. 
c.Kollektivt Bredband - 1000 Mbit/s levereras till 111 st. anslutningar. 
d.Kollektivt Bredband - 500 Mbit/s levereras till 7 st. anslutningar. 
e.Kollektivt Bredband - 100 Mbit/s levereras till 7 st. anslutningar. 
f.Kollektivt Bredband - 100 Mbit/s levereras till 7 st. anslutningar. 
g.Telia Telefoni levereras till 111 st. anslutningar. Parterna är överens om att 
...
h.Telia Telefoni levereras till 7 st. anslutningar. Parterna är överens om att 
samtalskostnader inte ingår i priset för den kollektiva tjänsten och att Boende ska betala 
ersättning till Telia för samtalskostnader enligt Telias vid var tid gällande prislista.
...
${CreatedDate}
 Sidnr
8 (30)
i.Telia Telefoni levereras till 111 st. anslutningar. Parterna är överens om att 
samtalskostnader inte ingår i priset för den kollektiva tjänsten och att Boende ska betala 
ersättning till Telia för samtalskostnader enligt Telias vid var tid gällande prislista.
j.Telia Telefoni levereras till 111 st. anslutningar. Parterna är överens om att 
samtalskostnader inte ingår i priset för den kollektiva tjänsten och att Boende ska betala 
ersättning till Telia för samtalskostnader enligt Telias vid var tid gällande prislista.
k.Telia Tv & Streaming Start levereras till 111 st. anslutningar (för undvikande av 
...
l.Telia Tv & Streaming Start levereras till 111 st. anslutningar (för undvikande av 
missförstånd noteras att endast privatbostäder ansluts till Tv från Telia). Förteckning av 
vid var tid aktuella kanaler framgår av telia.se. Parterna är dock överens om att Telia 
förbehåller sig rätten att ändra sammansättningen av kanaler. 
m.Telia Tv & Streaming Lagom levereras till 7 st. anslutningar (för undvikande av 
missförstånd noteras att endast privatbostäder ansluts till Tv från Telia). Förteckning av 
vid var tid aktuella kanaler framgår av telia.se. Parterna är dock överens om att Telia 
förbehåller sig rätten att ändra sammansättningen av kanaler. 
n.Telia Tv & Streaming Stor levereras till 7 st. anslutningar (för undvikande av missförstånd 
noteras att endast privatbostäder ansluts till Tv från Telia). Förteckning av vid var tid 
aktuella kanaler framgår av telia.se. Parterna är dock överens om att Telia förbehåller sig 
rätten att ändra sammansättningen av kanaler.     
Företag på Fastigheten i Lokal får tillgång till Bredbandstjänster genom kollektiv anslutning 
enligt nedan. För undvikande av missförstånd noteras att Företagslokaler aldrig ansluts till Tv 
från Telia. För kollektiva tjänster utgår en månadsavgift om 363.00 kr/mån per Lokal. 
Fakturering av Fastighetsägaren sker kvartalsvis. 
a.Telia Kollektivt Bredband Företag Start - 100/100 Mbit/s levereras till 7 st.    
...
Fastighetsnät ansluts för att leverera Bredbandstjänster till Boende/Företag. Access-switch placeras vanligtvis
i Fastighetens Teknikutrymme, vid Nätanslutningspunkten. 
Allmänna utrymmen är en Lokal som är belägen på Fastigheten men som inte disponeras av Företag.
Avtalet är detta avtal om Telia Fastighetsanslutning, inklusive bilagor, mellan Telia och Fastighetsägaren.
Boende är boende i Bostad belägen på Fastigheten.
Bostad är Boendes privatbostad i Flerfamiljshus, lokal som disponeras av näringsidkare eller annan lokal som
är belägen på Fastigheten.
Bostadsnät eller Lokalnät är fast installerad kabel med tillhörande LAN-uttag i Lokal. Bostadsnät/Lokalnät är 
installerat för stadigvarande bruk och används för att sprida Bredbandstjänster vidare från 
Överlämningspunkten. Bostadsnät/Lokalnät omfattas inte av Telias ansvar om inte annat framgår av Avtalet.
Bredbandsswitch är utrustning i Bostad/Lokal, som innehåller RJ45-portar genom vilka Tjänsteleverantör 
ges möjlighet att leverera Bredbandstjänst till Slutkund. Port på Bredbandsswitch eller Medieomvandlaren 
utgör Överlämningspunkt för Bredbandstjänst. Medieomvandlare i form av SFP är monterad i 
Bredbandsswitch i FTTH-nät. Bredbandsswitch ägs av Telia.
Bredbandstjänster är Tjänsteleverantörs vid var tid tillhandahållna slutkundstjänster, till exempel bredband 
och telefoni.
Enfamiljshus är byggnad på en enskilt ägd fastighet (villa, radhus, kedjehus, etc.) som utgör en Boendes 
privatbostad eller annan lokal på sådan Fastighet som disponeras av näringsidkare
Fastighet är den egendom som angivits i Avtalet. Som Fastighet anses även i förekommande fall byggnad på
ofri grund.
...
Nätanslutningspunkt. I FTTH-nät avslutas Fastighetsnät med ett opto-uttag i Bostad/Lokal alternativt med 
kontakt på inkommande fiber om opto-uttag saknas. I FTTB-nät avslutas Fastighetsnät i det första RJ45-
uttaget i Lokalen. Fastighetsnät ägs av Fastighetsägaren och omfattas inte av Telias ansvar om inte annat 
framgår av Avtalet.
Fastighetsägare är fysisk eller juridisk person som, ensam eller tillsammans med andra, äger den eller de 
Fastigheter som omfattas av Avtalet. Fastighetsägare enligt Avtalet kan t.ex. vara en ekonomisk förening, 
samfällighet eller aktiebolag.
Fel är avvikelse som medför att Bredbandstjänst inte är tillgänglig för Slutkund, eller där Bredbandstjänstens 
funktion är så kraftigt nedsatt att den är att betrakta som obrukbar.
...
Överlämningspunkt.
Företag är näringsidkare som är nyttjanderättshavare till en Lokal på Fastigheten.
Intag är kanalisation eller utrymme i en byggnads yttervägg som är avsedd att leda in Telias Nät i byggnaden.
Telia fastställer punkt för terminering av nätet.
Kanalisation är rör avsett för indragning av kabel. Kanalisation ingår inte i Fastighetsnät. Fastighetsägaren 
äger och ansvarar för Kanalisation, dock har Telia fri dispositionsrätt till sådan Kanalisation.
Kundplacerad Utrustning är utrustning (inklusive programvara), som ägs eller tillhandahålls av Telia och 
som placeras på Fastigheten för att möjliggöra tillhandahållandet av Bredbandstjänster till Företag. Utrustning 
placerad hos Slutkund som ett resultat av individuellt avtal omfattas inte av denna definition.
Lokal är lokal som disponeras av näringsidkare eller annan lokal som är belägen på Fastigheten.
Maximal åtgärdstid är den tidsperiod som det längst får ta att åtgärda ett Fel. Maximal åtgärdstid anges i 
timmar under gällande Servicetid och räknas fr.o.m. den tidpunkt då Telia mottagit felanmälan från 
Fastighetsägaren eller Telias tekniker gällande Fastighetsnätet t.o.m. den tidpunkt då Telia klarrapporterat 
...
12 (30)
anmält Fel.
Medieomvandlare är en nätkomponent i FTTH-nät som omvandlar den optiska signalen till elektrisk signal i 
Bostaden/Lokalen. Medieomvandlare är placerad vid Överlämningspunkt och kan vara en fristående enhet 
eller SFP monterad i Bredbandsswitch. Medieomvandlaren ägs av Telia. Servicevillkor för Medieomvandlare 
framgår av Avtalet.
Nätanslutningspunkt är punkt på Fastigheten där Fastighetsnätet/Områdesnätet ansluts till Telias Nät via 
Access-switch. Det kan finnas flera Nätanslutningspunkter inom en Fastighet. Fastighetsägaren upplåter plats 
för Kundplacerad utrustning i Nätanslutningspunkt.
Nätfel är avvikelse som medför att samtliga Slutkunder anslutna till en Access-switch är drabbade av Fel. 
...
Serviceansvar är ansvar för part att åtgärda Fel i angiven komponent, oavsett vem som ska bära kostnaden 
för åtgärden. Telias Serviceansvar innebär, förutom korrektiva åtgärder, preventiva åtgärder såsom 
uppgradering av mjukvara eller konfiguration.
...
Bredbandstjänst.
Telia är Telia Sverige AB.
Telias Nät är de allmänna kommunikationsnät som ägs eller på annat sätt disponeras av bolag inom Telia-
koncernen. Sådant bolag svarar för drift av Telias Nät. Telias Nät ansluts till Fastighetsnät via Kundplacerad 
Utrustning i en Nätanslutningspunkt.
Tjänsteleverantör är Telia eller den som ingått avtal med Telia om tillhandahållande av Bredbandstjänster till 
Slutkund i Överlämningspunkt.  
Tjänstespecifik hårdvara är hårdvara placerad efter Överlämningspunkt för Tjänsteleverantörs leverans av 
Bredbandstjänst t.ex. router, tv-box eller telefoniadapter. Villkor för Tjänstespecifik hårdvara framgår av avtal 
mellan Tjänsteleverantör och dennes avtalspart, vilket vid individuellt tecknade avtal är Slutkund. I de fall 
Fastighetsägare och Telia avtalar om kollektiv leverans framgår villkoren för den Tjänstespecifika hårdvaran 
av Avtalet.
Överlämningspunkt är den första punkt i Lokalen där Slutkund har möjlighet att ta emot Bredbandstjänst. I 
de fall Bredbandsswitch finns installerad utgör LAN-port på Bredbandsswitchen överlämningspunkt. Saknas 
Bredbandsswitch utgörs Överlämningspunkt av LAN-uttag (RJ45) på Medieomvandlare vid FTTH eller vid 
FTTB, första LAN-uttag.
...
14 (30)
Bilaga: Installation
Denna bilaga kompletteras av bestämmelserna i ”Bilaga: Allmänna villkor för Telia 
Fastighetsanslutning”.
För detaljerad teknisk beskrivning se ”Bilaga: Kravspecifikation”.
Omfattning 
Om Parterna uttryckligen kommit överens om installation av Fastighetsnät genom punkten 3 
(Tjänster och priser) i Avtalet, utförs installation av Fastighetsnät med CAT5E alternativt CAT6 för 
Bredbandstjänster eller i särskilda fall med fastighetsnät Fiber (FTTH). Vidare omfattar installationen 
av Fastighetsnät även leverans och montering av aktiv utrustning i av Fastighetsägaren tillhandahållet 
stativ eller skåp (dessa ska vara låsta för utomstående) samt installation av Kundplacerad Utrustning. 
Telia ansvarar för drift och underhåll av sådan utrustning under avtalstiden. 
...
Medieomvandlare placeras, dvs. i närheten av entrédörr. För det fall Telia sedan tidigare har 
installerad Kundplacerad Utrustning på Fastigheten har Telia ingen skyldighet att installera 
Kundplacerad Utrustning. Medieomvandlare tillhandahålls och ägs av Telia.
...
Flytt av skrymmande föremål och möbler.
Kostnad för eventuella eluttag i Bostäder/Lokaler och i Fastighetens Teknikutrymme.
Installation av Fastighetsnät, Bostadsnät/Lokalnät och Områdesnät (om inte uttryckligen avtalats
i detta Avtal).
Håltagning i känsliga material som kakel, sten m.m.
Arbete med miljöfarligt material, t.ex. asbest.
Merkostnad för installation i K-märkta byggnader.
...
Test eller annat jobb i utrustning som ägs av kunden (t.ex. pc, tv, router, dvd, etc.).
Slutbesiktning
Slutbesiktning ska vid behov utföras i de fall Avtalet omfattar installation av Fastighetsnät. Syftet med 
en slutbesiktning är att kontrollera att installationen utförts i enlighet med Avtalet. Fastighetsägaren 
kallar Telia till slutbesiktningen om Fastighetsägaren anser att det finns behov av en slutbesiktning. 
...
Slutbesiktningen är okulär och omfattar endast de Bostäder/Lokaler som Fastighetsägaren skaffat 
tillträde till. Bostäder/Lokaler till vilka tillträde inte lämnats för slutbesiktning ska anses vara godkända 
och utan anmärkning. Vid slutbesiktningen ska ett särskilt slutbesiktningsprotokoll upprättas genom 
...
installationen anses godkänd av fastighetsägaren vid avtalad leveransdag. Är installationen försenad, 
ska installationen anses godkänd vid färdig installation. 
...
installationsprocessen samt andra relevanta frågor. Respektive part ska utse var sin kontaktman för 
att ansvara för att hantera löpande frågor rörande installationen. Vardera Parten ska bära sina 
respektive kostnader för startmötet. 
...
byggnader som omfattas av Avtalet, ritningar över kablage avsedda för el m.m. Fastighetsägaren 
ansvarar för att sådan information är korrekt och fullständig. Eventuella skador vid borrning betalas av 
Fastighetsägaren om inte korrekta ritningar erhålls.
Fastighetsägaren är ansvarig för Fastighetsnätet och de Överlämningspunkter som finns och att 
korrekt information rörande detta kommer Telia till handa.
...
tjänster från Telia genom punkten 3 (Tjänster och priser) i Avtalet utförs installationshjälpen enligt 
nedan:
LAN-uttag eller medieomvandlare lokaliseras.
...
Bilaga: Kravspecifikation
Kravspecifikation Telia Fastighetsanslutning, Telia Öppen Fiber (FTTH & FTTB)
Detta dokument beskriver Telias kravspecifikation för byggnation samt installation av FTTH & FTTB 
nät för produkterna Telia Fastighetanslutning och Telia Öppen Fiber.
...
Avser kabel i bostad. Bostadsnätet börjar där Fastighetsnätet avslutas.
Områdesnät
Avser fiberkabel inom en eller mellan flera byggnader (såsom bostadsbyggnad, teknikutrymmen osv.) 
...
Avser det utrymme där Telia utrustning skall placeras.
GAP
Gruppanslutningspunkt. Fastighets- och områdesnätets centrala punkt. GAP består av stativ, 
kopplingspaneler samt aktiv utrustning.
Teknisk specifikation
Tillträde till Fastigheten
...
18 (30)
Fastighetsnät (FTTH)
För Fastighetsnät FTTH, och i förekommande fall Områdesnät, ska kabeltypen vara singlemode-fiber 
av typ ITU-T G.652C eller D användas och vara utfört enligt Svensk Standard SS-EN 501 73-1 med 
bilagor.
Fibrerna termineras i Nätanslutningspunkt med skarvstycken avsedda för singlemode-kontakter. 
Uttagen i Nätanslutningspunkt ska vara märkta med unik lägenhetsidentifikation. I bostaden avslutas 
fibern i här för avsett fiberuttag. Alla ingående kontakter ska vara av typ SC/UPC med max 0,5 dB 
kontaktdämpning och minst 50 dB reflexionsdämpning. Skarvar på fibrerna får dämpa max 0,5 dB.
...
nätschema fiber och godkänt mätprotokoll för Fastighetsnät och Områdesnät. Dokumentationen ska 
lämnas till Telias kontaktperson innan driftsättning kan ske. Fastighetsägaren ansvarar för att 
anläggningen uppfyller ställda krav.
Medieomvandlare
Medieomvandlare ska uppfylla kraven för standard 1000 Base-BX10-U (1310 nm TX/1550 nm RX;10 
km). I det fall Medieomvandlare levereras av annan än Telia förbehåller sig Telia rätten att testa den 
föreslagna Medieomvandlaren. I annat fall kan inte leverans av Telias tjänster garanteras. 
Fastighetsnät (FTTB)
Fastighetsnät FTTB består av koppar in i Bostaden respektive Enfamiljshus. 
...
Fastighetsnätet ska vara installerat med separata anslutningar till varje bostad och lokal. Det innebär 
att nätet ska vara stjärnkopplat. Fastighetsnätet ska uppfylla Ethernetstandard IEEE 802.3.
Installationen av kabel bör ske i Fastighetens befintliga kanalisation.
Kanalisation i nybyggnad bör utföras enl. SIS 437 0145; grundläggande dimensioneringsregler för 
...
Fastighetsnätet utgår från RJ45-uttag i kopplingspanelen (som placeras i 19" stativ) och avslutas med 
RJ45-uttag i varje Bostad. Uttagen ska vara märkta med unik identifikation.
Mätning av Fastighetsnät koppar ska uppfylla standard EN50173 PL Class D eller E (Cat6).
Om befintligt Fastighetsnät används är minimikravet på kabeltyp minst Cat5e, SS-EN 50173-1:2018. 
För testresultat som uppfyller ställda krav ansvarar Fastighetsägaren.
Kabeln för Fastighetsnät ska vara av halogenfritt material och oskärmad. Förläggning av kabel ska ske
med hänsyn tagen till kabelns mekaniska och miljömässiga omgivningskrav.
Kabellängd
Fastighetsnätets totala längd per anslutning får ej överstiga 90 meter från korskopplingspanelen till 
uttag i bostad.
...
Områdesnät
Områdesnätet skall vara draget från Spridningspunkten och vara i form av ett stjärnformat fibernät 
som ansluter andra Fastighetsnät inom samma Fastighet.
Områdesnätet ska installeras med standard singlemode-fiber av typ ITU-T G.652C eller D. Fibrerna 
termineras i varje ända i en Nätanslutningspunkt med skarvstycken avsedda för singlemode-kontakter.
Alla ingående kontakter skall vara av typ SC/UPC med max 0,5 dB kontaktdämpning och minst 50 dB 
reflexionsdämpning. Nätet ska innehålla minst 8 fiber (=4 par) till respektive teknikutrymme. Skarvar 
på fibrerna får dämpa max 0,5 dB.
Teknikutrymmen
Teknikutrymmen ska både innehålla Nätanslutningspunkt samt 
kundplacerad Access-switch och ska vara centralt lokaliserat i 
respektive byggnad eller i området. Teknikutrymmet ska vara ett 
låsbart utrymme eller ett låsbart skåp för Kundplacerad Utrustning, 
placerat inomhus. Fastighetsägaren ansvarar för att utrymmet är 
låst och otillgängligt för obehöriga. Utrymmet ska dock vara så 
åtkomligt att Telia och Telias servicetekniker kan sköta drift och 
underhåll. 
I detta utrymme installeras ett eget 19"-stativ. På detta stativ ska 
Fastighetsnätets kopplingspaneler samt Telias utrustning, 
monteras. Generellt utrymmesbehov för 19"-stativet är bredd 60 cm,
djup 50 cm och höjd minst 80 cm i ett stativ, beroende på 
anläggningens storlek. 
Utrymmet ska vara sådant att förhållandet mellan temperatur och 
fuktighet gör att kondens inte uppstår.
Utrymmet ska klara krav enligt ETS 300 019-1 klass 3.
Driftstemp: +5° till +40°C
Luftfuktighet: 5% till 85%
Bakom stativet ska det alltid finnas minst ett jordat uttag per planerad switch, utöver detta, ska minst 
ett jordat dubbeluttag finnas för service.
...
utrustning. Stativet kan vara jordat. Placeras stativet i skåp ska utrymmet mellan stativfront och dörr 
vara minst 10 cm.
Kundplacerad utrustning
Kundplacerad utrustning ska placeras i Fastighetsägarens 19"-stativ/skåp där Fastighetsägaren ska 
lämna plats för utrustningen.
Beskrivning av 19"-stativ 
med kopplingspaneler och 
aktiv utrustning.
...
Grävning och byggande av kanalisation i mark
Kanalisation skall förläggas enligt följande specifikation. För ytterligare information hänvisas till: 
(Anläggnings AMA 98), AMA anläggning 07.
...
Ledningsgrav med kanalisationsrör.
Ledningsbädden skall vara 10 cm tjock, jämn och utföras med finkornigt, kompakterat materiel med 
max 8 mm diameter. Kringfyllningen görs till 10 cm ovanför kanalisationsröret och med samma 
materielkrav som ledningsbädden. Kompakteras. Markeringsnät läggs ovanpå kringfyllningen. Det 
skyddar kanalisationsröret och den inbyggda söktråden är till hjälp vid en kabelutsättning i samband 
med markarbeten. Resterande fyllning görs enligt markägarens önskemål.
...
Anslutning av Bostad och Lokal 
Anslutning sker mellan Telias och Fastighetsnätets kopplingspaneler. Denna anslutning sker genom 
att en patchkabel monteras i uttag på Telias utrustning till uttag för aktuell Bostad eller Lokal.
Dokumentation
...
Bilaga: Service
Serviceansvar för Telia Fastighetsanslutning, Telia Öppen Fiber (FTTH & FTTB)
Detta dokument beskriver Telias respektive Fastighetsägarens Serviceansvar för det fall Parterna 
ingått avtal om Telia Fastighetanslutning eller Telia Öppen Fiber.
Servicebeskrivning
Ägande och Serviceansvar FTTH-nät
Eventuellt Områdesnät ägs av Fastighetsägaren, som har Serviceansvar för detta.
Fastighetsnätet ägs av Fastighetsägaren, som har Serviceansvar för detta.  
...
behäftad med Fel efter Felanmälan från Boende eller Fastighetsägare. Vid yttre åverkan på 
Medieomvandlare fakturerar Telia Fastighetsägaren för byte av Medieomvandlare enligt gällande 
prislista. Detta under förutsättning att Medieomvandlaren inte omfattas av leveransgaranti enligt 
”Bilaga: Installation”.
Eventuell Bredbandsswitch ägs av Telia som även har Serviceansvar för denna. Endast Telia har 
rätt att managera Bredbandsswitch, vilket innebär att endast Telia har rätt att logga in i denna, 
eller på annat sätt påverka dess konfiguration.
Tjänstespecifik hårdvara regleras avseende ägande och Serviceansvar beroende av kollektivt 
eller individuellt avtal med Tjänsteleverantör. I kollektiva avtal äger Fastighetsägaren tv-box, 
...
finns en lämplig yta att placera denna på i respektive Bostad/Lokal. För de fall teknikskåp har 
byggts ansvarar Fastighetsägaren för att detta är byggt i ett material som wifi-signal kan ta sig 
...
utförande 
serviceåtgärd
TeliaFastighetsägareTeliaTeliaFastighetsägare
Tjänsteleverantör, 
Slutkund
Ansvar 
betalning 
...
${CreatedDate}
 Sidnr
22 (30)
RJ45-uttag vid respektive Slutkunds Överlämningspunkt ägs av Fastighetsägaren. Telia har 
Serviceansvar för RJ45-uttag, vilket innebär att Telia ersätter RJ45-uttag som är behäftad med 
Fel efter Felanmälan från Boende eller Fastighetsägare. I dessa fall fakturerar Telia 
Fastighetsägaren för felavhjälpning av RJ45-uttag, 700 kr exklusive moms per RJ45-uttag. Detta 
under förutsättning att RJ45-uttag inte omfattas av leveransgaranti enligt ”Bilaga: Installation”.
Eventuell Bredbandsswitch ägs av Telia som även har Serviceansvar för denna. Endast Telia har 
rätt att managera Bredbandsswitch, vilket innebär att endast Telia har rätt att logga in i denna, 
eller på annat sätt påverka dess konfiguration.
Tjänstespecifik hårdvara regleras avseende ägande och Serviceansvar beroende av kollektivt 
...
3.Tjänsteleverantör felsöker och åtgärdar vid behov sin tjänsteplattform, samt kontrollerar att 
Slutkundens inkoppling till Bredbandstjänsten är korrekt och att Felet inte finns i Slutkundens egen 
utrustning eller handhavande av Bredbandstjänsten. 
...
felanalys och åtgärdar eventuella Fel som ligger inom Telias Serviceansvar, dvs. Fel i Access-
switch eller Medieomvandlare.
6.Om Telias serviceteknikers felanalys visar att Felet ligger inom Fastighetsägarens Serviceansvar, 
exempelvis i Fastighetsnät, överlämnar Telia felärendet till Fastighetsägaren för åtgärd.
...
omfattar Access-switchar samt all övrig utrustning i Telias Nät. Telia tar hand om larm från nätet och 
genomför fjärrmässig analys och om möjligt fjärrmässig felavhjälpning. 
...
landet. 
Telias hantering av nätfel
1.Telias utrustning larmar om samtliga Slutkunder anslutna till en Access-switch drabbas av Fel, dvs 
ett Nätfel uppstår. Detta gör det möjligt för Telia att ge sina Slutkunder information om ett pågående
Nätfel, t.ex. när Felet beräknas vara åtgärdat. 
2.I de fall Telias analys visar att Nätfelet endast berör Access-switch kontaktas Fastighetsägarens 
tekniske kontaktperson för att verifiera om strömförsörjningen fungerar, eller om det finns andra 
omständigheter som förorsakat Nätfelet. Om så inte är fallet, och felet inte kan felavhjälpas 
fjärrmässigt, skickar Telia en tekniker för att felsöka.  
3.Prioritering av felavhjälpning av Nätfel som inte går att åtgärda fjärrmässigt är beroende av antal 
drabbade Slutkunder: fler drabbade Slutkunder medför högre prioritet. Maximal åtgärdstid för Nätfel
är 24 timmar för privatkund respektive 12 timmar för företagskund inom ramen för Servicetid – se 
tabell ovan.
Planerade arbeten i Telias Nät
...
${CreatedDate}
 Sidnr
24 (30)
Utföra kontroll av strömförsörjning av Access-switch inom 60 minuter efter Telias anmodan vid 
Nätfel som misstänks bero på problem med strömförsörjning av Access-switch då 
Fastighetsägaren ansvarar för denna strömförsörjning. Fastighetsägaren ska omgående 
informera Telia om resultatet av kontrollen, samt omedelbart agera för att avhjälpa identifierade 
problem. Detta gäller alla dagar kl. 07.30-22.00.
...
Åtgärda Fel inom Fastighetsägarens ansvar som drabbar enskild Slutkund inom 24 timmars 
Maximal åtgärdstid mätt under Servicetid helgfri må-fre kl. 07.30-18.00 då Fel berör privatkund. I 
det fall Fel berör företagskund är Maximal åtgärdstid 12 timmar mätt under Servicetid 07.30-18.00
helgfri må-fre. Till denna kategori av fel hör bland annat Fel i Fastighetsnät orsakat av åverkan.
Åtgärda Fel inom Fastighetsägarens ansvarsområde som medför att samtliga kunder anslutna till 
Access-switch är drabbade av Fel med 8 timmars Maximal åtgärdstid mätt under servicetid 07.30-
22.00 alla dagar. Till denna kategori av Fel hör bland annat Fel i Områdesnät samt fel i 
strömförsörjning av Access-switch som kan åtgärdas av Fastighetsägaren. 
Fastighetsnät, teknikutrymme m.m. uppfyller krav enligt ”Bilaga: Kravspecifikation”. 
Telias utrustning i Nätanslutningspunkten är skyddad från allmänheten, vilket även innefattar att 
utrustning ej ska vara åtkomlig för Boende. Detsamma gäller även kopplingspunkter i 
Fastighetsnät och Områdesnät. 
...
Bilaga: Allmänna villkor 
Telias Integritetspolicy 
Den personliga integriteten hos våra kunder är viktig för oss på Telia. I Telias integritetspolicy på www.telia.se finns 
mer information om vilka personuppgifter Telia behandlar, typ av behandling, ändamålet och den rättsliga grunden 
för behandlingen, uppgifternas lagringstid samt individens rätt till bl.a. information, rättelse, radering och rätten att 
göra invändningar. 
1.Inledning
1.1Dessa allmänna villkor gäller då Telia till en 
Fastighetsägare möjliggör anslutning av 
Fastighetsnät för Bostäder/Lokaler till Telias 
Nät. Efter överenskommelse kan Telia även 
tillhandahålla andra tjänster, såsom installation
av Fastighetsnät, service av Fastighetsnät, 
Telias Bredbandstjänster genom kollektiv 
anslutning till Boende/Företag på aktuella 
Fastigheter eller anslutning till Öppen Fiber. 
De tjänster som tillhandahålls specificeras i 
Avtalet.
1.2Avtalet reglerar inte tillhandahållande av 
Bredbandstjänster i relationen direkt till 
Boende/Företag. Boende/Företaget kan få 
tillgång till Bredbandstjänst kollektivt via 
Fastighetsägaren eller individuellt genom att 
teckna ett särskilt avtal om Bredbandstjänst 
...
namn, adress och eventuell e-postadress. 
Genom att aktivera Bredbandstjänsten ingår 
Boenden/Företaget särskilt avtal med Telia om
Bredbandstjänsten.
2.Telias åtaganden 
2.1Telia ska tillhandahålla aktuella tjänster på ett 
fackmässigt sätt i överensstämmelse med 
Avtalet.
2.2Telia har rätt att anlita underleverantörer för att
fullgöra sina åtaganden enligt Avtalet. Telia 
svarar i så fall för underleverantörens arbete 
såsom för eget arbete
2.3Vid anslutning till Telias Nät av Fastighetsnät i 
befintlig bebyggelse ska anslutningen ske vid 
den tidpunkt som skriftligen överenskommits 
mellan Parterna. Telia ansvarar för leverans av
kabel fram till Nätanslutningspunkten.
...
Fastighetsägaren, någon som 
Fastighetsägaren svarar för, Boende, Företag 
eller besökare till Boenden eller Företaget. 
Innan grävning påbörjas inom Fastighet 
...
motsvarande förhållanden som där anges, 
oavsett om detta har sin grund i handlande 
eller underlåtenhet från Fastighetsägarens 
eller från Boendens/Företagets sida.
3.Fastighetsägarens åtaganden
3.1Fastighetsägaren ska på egen bekostnad 
bereda Telia tillträde till Fastigheten. Med 
avseende på byggnation, installation och/eller 
anslutning av Fastighetsnät ska Telia ges 
tillträde skyndsamt och utan vidare dröjsmål. 
Med avseende på service ska Telia ges 
tillträde i enlighet med vad som framgår av 
Avtalet. Telia ska beredas fri framkomlighet 
där arbeten ska utföras. Flytt av möbler och 
liknande omfattas inte av Telias åtaganden. 
Fastighetsägaren ska vidare förse Telia med 
lista över kontaktpersoner avseende tillträde till
Fastigheten.
3.2Fastighetsägaren ansvarar för att eventuellt 
bygglov och andra myndighetstillstånd som 
avser Fastigheten i förekommande fall 
införskaffas för anläggning av det som ska 
installeras. Motsvarande gäller om 
Fastighetsnät ägs av annan än 
Fastighetsägaren och Telia behöver tillstånd 
...
tillstånd. Om tillstånd inte medges, har Telia 
rätt att med omedelbar verkan frånträda 
Avtalet.
3.3Fastighetsägaren ansvarar för att 
Fastighetsnätet uppfyller de krav som anges i 
bilagan Kravspecifikation liksom i Avtalet i 
övrigt för att anslutning ska kunna ske, t.ex. att
teknikutrymmen, eluttag, kanalisation mellan 
Nätanslutningspunkt och i förekommande fall 
Fastighetsnät, är etablerat innan anslutning 
påbörjas. Fastighetsägaren ansvarar för att 
nödvändig kanalisation förläggs på riktigt sätt. 
Vid Intag ovan mark ansvarar 
...
åverkan. För Fastighetsnät som ska användas 
för tillhandahållande av Kabel-tv ansvarar 
Fastighetsägaren särskilt för att 
Fastighetsnätet uppfyller den standard som 
anges i Avtalet. 
3.4Fastighetsägaren ansvarar för drift och 
underhåll av Fastighetsnät och att sådant nät 
kontinuerligt uppfyller de krav som anges i 
Avtalet. Fastighetsägaren ansvarar för att utan 
oskäligt dröjsmål avhjälpa fel i Fastighetsnät. 
Om Parterna har avtalat att Telia ska 
tillhandahålla service av Fastighetsnät m.m. 
ska härutöver avsnitt 4 tillämpas.
...
underleverantör företa sådan framdragning av 
el på Fastighetsägarens bekostnad. 
Fastighetsägaren ansvarar vidare för den 
strömförbrukning som är nödvändig för driften 
...
installerats. Kundplacerad Utrustning får inte 
utan Telias skriftliga medgivande flyttas från 
den plats där den installerats.
3.7Fastighetsägaren får inte utan Telias skriftliga 
medgivande reparera, utföra service på, göra 
påbyggnader på eller ändringar i, eller ta bort 
delar eller märkning avseende 
ägandeförhållanden från Kundplacerad 
Utrustning. Fastighetsägaren ska följa de 
anvisningar som Telia från tid till annan 
...
person ges tillgång till Kundplacerad 
Utrustning och Fastighetsägaren ska 
omedelbart meddela Telia om så ändå sker.
3.8Fastighetsägaren ska vidta alla rimliga 
åtgärder för att säkerställa att inte 
Boende/Företag eller annan vidtar åtgärder 
som medför störningar för Fastighetsnätet och 
Kundplacerad Utrustning. Fastighetsägaren 
svarar även för att utan oskäligt dröjsmål 
stoppa sådana störningar.
4.Installation av Fastighetsnät
4.1Om Parterna överenskommit att Avtalet ska 
omfatta även installation av Fastighetsnät, 
gäller punkterna 4.2 – 4.5 nedan. Installation 
av Fastighetsnät omfattar anläggande av kabel
och i förekommande fall kanalisation, inklusive 
nödvändiga anslutningar och uttag i byggnad 
på det sätt som anges i Avtalet.
4.2Telia kallar Fastighetsägaren till ett startmöte i 
syfte att gå igenom installationsprocessen och 
andra relevanta frågor. Respektive Part ska 
utse var sin kontaktman för att ansvara och 
hantera löpande frågor rörande installationen. 
Vardera Parten ska bära sina respektive 
kostnader för startmötet. På startmötet ska 
Parterna överenskomma om detaljerad tidplan 
och former för arbetets utförande.
4.3I god tid innan installationen påbörjas och 
senast vid startmötet ska Fastighetsägaren 
förse Telia med fastighetsbeskrivning, ritningar
över Fastigheten och berörda byggnader 
utvisande nödvändig information för anslutning
och installation. Fastighetsägaren ansvarar för 
att sådan information är korrekt och fullständig.
4.4Installation och/eller anslutning av 
Fastighetsnät i såväl nybyggnation av byggnad
som i befintlig bebyggelse ska ske vid den 
tidpunkt som skriftligen överenskommits 
mellan Parterna.
4.5Fastighetsägaren ansvarar för kanalisation 
från tomtgränsen fram till 
Nätanslutningspunkten.
5.Ersättning 
5.1Fastighetsägaren ska betala i Avtalet 
överenskommen ersättning. Samtliga priser är 
exklusive mervärdesskatt. Fakturaavgift 
tillkommer för pappersfaktura.
5.2Fastighetsägaren ska betala faktura inom 
trettio (30) dagar från fakturadatum i enlighet 
med anvisningar angivna på fakturan. Vid 
förskottsbetalning enligt punkt 5.5 ska 
betalning ske senast den dag Telia anger.
5.3Debitering av i Avtalet ingående tjänster 
påbörjas vid tidpunkt som Parterna 
överenskommit i Avtalet eller annars på 
avtalad leveransdag eller, om leveransen är 
försenad av orsak enbart hänförlig till Telia, 
från den dag då leverans faktiskt sker.
5.4Om Fastighetsägaren inte fullgjort betalningen 
senast på förfallodagen har Telia rätt till 
ersättning för betalningspåminnelser och 
inkassokostnader samt till dröjsmålsränta 
enligt lag. Om Fastighetsägaren, trots 
påminnelse och stängning av Tjänsten inte 
betalar förfallen faktura, ska övrig ersättning 
för Tjänsten som ännu inte har fakturerats 
anses förfallen till omedelbar betalning.
5.5Telia har rätt att under avtalstiden begära 
förskottsbetalning eller att Fastighetsägaren 
ställer säkerhet för Avtalets rätta fullgörande 
om det till följd av kreditprövning framstår som 
befogat. Ränta utgår inte på förskotterat 
belopp. Telia har vidare rätt att ur förskotterat 
belopp eller ställd säkerhet tillgodogöra sig 
belopp motsvarande sina förfallna fordringar, 
inklusive sådana kostnader som avses i punkt 
5.4.
5.6Telia har rätt att överlåta sin rätt till betalning 
enligt Avtalet till annan.
...
6.Äganderätt och nyttjanderätt
6.1Om inte annat anges ska Fastighetsägaren 
inneha äganderätten till Fastighetsnätet och 
tillhörande Kanalisation.
6.2Telias Nät ägs eller disponeras av bolag inom 
Telia-koncernen fram till och med 
Nätanslutningspunkten. 
Nätanslutningspunkten kan vara placerad vid 
fastighetsgränsen eller inne på Fastigheten. 
Om Nätanslutningspunkten är placerad inne 
på Fastigheten åtar sig Fastighetsägaren att 
på begäran av sådant Telia bolag teckna ett 
särskilt upplåtelseavtal i enlighet med särskild 
bilaga avseende rätt för bolaget att anlägga 
och bibehålla nät fram till och med 
Nätanslutningspunkten på Fastigheten samt i 
förekommande fall på gator, enskilt ägda 
fastigheter, etc. inom det område som 
omfattas av Avtalet.
6.3Kundplacerad Utrustning, t.ex. Telias Access-
switch, ägs av Telia som svarar för drift och 
underhåll av denna utrustning. Ägande och 
ansvar för annan utrustning som Telia 
installerat i Bostad/Lokal framgår av Avtalet. 
Telia förbehåller sig rätten att utföra 
konfigurationsändringar, uppgraderingar samt i
övrigt disponera den Kundplacerade 
Utrustningen för utveckling av tjänster under 
den tid som utrustningen är ansluten mot 
Bredbandstjänst. Under omständighet att den 
Kundplacerade Utrustningen inte ägs av Telia, 
förbehåller sig Telia likväl rätten att utföra 
konfigurationsändringar, uppgraderingar samt i
övrigt disponera sådan utrustning för 
utveckling av tjänster under den tid som 
utrustningen är ansluten mot Bredbandstjänst.
6.4Fastighetsägaren ger Telia rätt att i den 
omfattning som behövs bygga ut Telias Nät 
inom Fastigheten fram till 
Nätanslutningspunkten.
6.5Fastighetsägaren ger Telia rätt att under 
avtalstiden utan ersättning nyttja Fastighetens 
Teknikutrymme inklusive elektricitet, värme 
och kyla.
6.6Avtalet innebär inte att äganderätten till 
Kundplacerad Utrustning övergår till 
Fastighetsägaren och Fastighetsägaren får 
inte sälja, pantsätta, hyra eller låna ut eller på 
annat sätt förfoga över sådan utrustning utan 
att Telia först lämnat skriftligt medgivande 
därtill.
6.7Fastighetsägaren ska under avtalstiden 
tillförsäkra Telia en exklusiv nyttjanderätt till 
Fastighetsnätet och Kanalisationen för 
tillhandahållande av Bredbandstjänster.
7.Överlåtelse av rättigheter och skyldigheter
7.1Med undantag för de särskilda fall som anges 
nedan, har Part inte rätt att överlåta sina 
rättigheter och skyldigheter enligt Avtalet utan 
den andre Partens skriftliga samtycke. Telia 
har dock rätt att överlåta sina rättigheter och 
skyldigheter enligt Avtalet till annat bolag inom 
Telias koncern. Telia ska skriftligen meddela 
Fastighetsägaren om detta sker.
7.2Fastighetsägaren garanterar att denne vid 
överlåtelse av Fastigheten ska göra förbehåll 
för de nyttjanderätter och andra rättigheter 
som upplåts till Telia eller annat Telia bolag 
enligt Avtalet, så att Avtalet gäller mot 
förvärvare av Fastigheten. Fastighetsägaren 
ska vid överlåtelse av Fastigheten överlåta 
sina rättigheter och skyldigheter enligt Avtalet 
till förvärvare av Fastigheten.
7.3Vad som sägs i punkt 7.2 ska gälla även vid 
annan fastighetsrättslig reglering eller vid 
överlåtelse av Fastighetsnätet eller del därav.
8.Förtida upphörande
8.1Vardera Parten får säga upp Avtalet med 
omedelbar verkan om: den andra Parten 
inleder likvidationsförhandlingar, inger ansökan
om företagsrekonstruktion, inleder ackord, 
försätts i konkurs eller eljest kan antas vara på 
obestånd, eller; den andra Parten har gjort sig 
skyldig till väsentligt avtalsbrott som inte 
åtgärdats inom tio (10) arbetsdagar efter 
skriftlig begäran.
8.2Uppsägning enligt punkt 8.1 ska ske skriftligen.
8.3Definitionerna i Avtalets Bilaga 1 samt 
bestämmelserna i dessa Allmänna villkor 
punkterna 3.4 - 3.6, 7.1 – 7.3, 9.1 – 9.4, 10.1 - 
10.3, 11.1 – 11.3 samt 13.1 – 13.3 ska äga 
fortsatt giltighet även efter Avtalets 
upphörande till dess Telias avtal med 
Boende/Företaget om Bredbandstjänst upphört
att gälla.
9.Skadestånd
9.1Part har rätt till ersättning för direkt skada som 
motparten, eller någon för vilken motparten 
svarar, förorsakat genom vårdslöshet. Part har
inte någon rätt till ersättning för indirekta 
skador, såsom utebliven handelsvinst, 
kostnader som blivit onyttiga eller andra 
följdskador. Parts ansvar är vidare för varje 
skadetillfälle begränsat till ett sammanlagt 
belopp motsvarande trettiofem (35) 
prisbasbelopp enligt lagen (1962:381) om 
allmän försäkring, om inte annat anges i 
Avtalet.
9.2Oaktat vad som föreskrivs i punkt 9.1 ovan 
ansvarar Telia inte för skada som uppkommer 
för Fastighetsägaren till följd av innehåll i data 
eller annan information som förmedlas vid 
användning av tjänster enligt Avtalet, inte 
heller ansvarar Telia för skada orsakad av 
datavirus eller motsvarande, försening, 
förvanskning eller förlust av data eller för 

Konfidentiellt
${CreatedDate}
 Sidnr
28 (30)
Fastighetsägaren eventuella 
ersättningsskyldighet gentemot tredje man.
9.3Begränsningarna av Parts 
skadeståndsskyldighet gäller inte i fall av 
uppsåt eller grov vårdslöshet, vid personskada
eller vid sådant ansvar som följer av tvingande 
lag. Begränsningarna av Parts 
skadeståndsskyldighet gäller vidare inte vid 
skada som uppkommit till följd av att 
Fastighetsägaren brutit mot punkt 7.2 eller 7.3.
9.4Begäran om skadestånd skall, för att kunna 
göras gällande, framställas skriftligen senast 
två (2) månader efter det att felet, förseningen 
eller skadan upptäckts eller bort upptäckas.
10.Force majeure
10.1Part är befriad från skyldighet att ersätta skada
eller att fullgöra viss förpliktelse enligt Avtalet, 
om skadan eller underlåtenheten har sin grund
i omständighet utanför Parts kontroll, av det 
slag som anges nedan ("Befriande 
Omständighet") och omständigheten 
förhindrar, avsevärt försvårar eller försenar 
fullgörande av sådan förpliktelse. Detsamma 
gäller om underlåtenheten har sin grund i 
försenade leveranser från Parts 
underleverantör som orsakats av Befriande 
Omständighet.
10.2Såsom Befriande Omständighet ska anses 
bland annat myndighetsåtgärd eller 
underlåtenhet, nytillkommen eller ändrad 
lagstiftning, arbetskonflikt, blockad, krig, 
upplopp, sabotage, extrema 
väderförhållanden, blixtnedslag, brand, 
explosion, översvämning, naturkatastrof, 
olyckshändelse eller kabelbrott som orsakats 
av tredje man.
10.3Part som påkallar befrielse enligt punkt 10.1 
ska utan dröjsmål underrätta andra Parten 
därom. Befrielsegrund anses föreligga så 
länge Befriande Omständighet utgör hinder för 
fullgörande, dock högst tre (3) månader. 
Därefter har vardera Parten rätt att frånträda 
Avtalet utan att några påföljder på grund av 
detta kan göras av den andra Parten.
11.Sekretess
11.1Part förbinder sig att inte för tredje man avslöja
Konfidentiell Information, vilken Part erhåller 
eller erhållit från den andra Parten. Med 
"Konfidentiell Information" avses varje 
upplysning - teknisk, kommersiell eller av 
annan art, förutsatt att sådan information 
rimligen kan anses vara av konfidentiell natur, 
oavsett om upplysningen dokumenteras eller 
inte - med undantag för:
a)upplysning, som är allmänt känd eller 
kommer till allmän kännedom på annat sätt
än genom brott mot innehållet i Avtalet, 
eller,
b)upplysning, som Part kan visa att Part 
redan kände till innan han mottog den från 
den andra Parten, eller,
c)upplysning, som Part mottagit eller kommer
att mottaga från tredje man utan att vara 
bunden av sekretessplikt i förhållande till 
denne.
11.5Bestämmelserna i punkt 11.1 innebär inte 
hinder för Part att lämna ut Konfidentiell 
Information när sådant erfordras på grund av 
bestämmelse i lag eller på grund av domstols 
eller myndighetsbeslut.
11.6Telia får lämna ut Konfidentiell Information till 
annat bolag inom Teliakoncernen. Därutöver 
får den Part som mottar Konfidentiell 
Information lämna ut informationen endast till 
sådana anställda, styrelseledamöter, konsulter
och underleverantörer som behöver tillgång till 
informationen för att Avtalet ska kunna 
fullföljas. Mottagande Part ansvarar för att 
sådana personer före sådant utlämnande är 
medvetna om och följer bestämmelserna i 
Avtalet.
12.Övrigt
12.1Ändringar av eller tillägg till Avtalet ska för att 
vara bindande vara skriftligen avfattade och 
undertecknade av Parterna.
12.2Avtalet utgör Parternas fullständiga reglering 
av alla frågor som Avtalet berör. Alla skriftliga 
eller muntliga överenskommelser, åtaganden 
eller utfästelser som föregått Avtalet ska 
ersättas av innehållet i Avtalet.
...
uppgivit senast i samband med Avtalets 
ingående, dels att installations- och 
anslutningsarbetena inte i övrigt stöter på 
hinder som inte skäligen kunde förutses av 
Telia vid Avtalets ingående. I annat fall har 
Telia rätt till ersättning från Fastighetsägaren 
för eventuella tillkommande kostnader.
12.4Telia utvecklar fortlöpande sina tjänster och 
tekniska plattformar. Telia äger rätt att ändra 
eller modifiera tjänsterna som levereras under 
detta Avtal, inklusive tekniska plattformar, 
under förutsättning att tjänsternas prestanda 
eller funktionalitet därmed inte försämras. 
Sådan ändring eller modifiering ska utföras på 
ett sådant sätt att eventuella störningar 
begränsas.
13.Tillämplig lag och tvist
13.1Parternas rättigheter och skyldigheter vid 
tolkning och tillämpning av Avtalet ska 
bestämmas i enlighet med svensk lag.
13.2Tvist i anledning av Avtalet ska slutligt avgöras
i Stockholm genom skiljedom vid Stockholms 
...
(”Institutet”).
13.3Institutets Regler för Förenklat Skiljeförfarande
ska gälla om inte Institutet med beaktande av 
målets svårighetsgrad, tvisteföremålets värde 
eller övriga omständigheter bestämmer att 
Reglerna för Stockholms Handelskammares 
Skiljedomsinstitut ska tillämpas på förfarandet. 
I sistnämnda fall ska Institutet också 
bestämma om skiljenämnden ska bestå av en 
eller tre skiljemän. Oaktat vad ovan anges har 
Part rätt att vända sig till svensk domstol eller 
annan behörig myndighet om tvistigt 
