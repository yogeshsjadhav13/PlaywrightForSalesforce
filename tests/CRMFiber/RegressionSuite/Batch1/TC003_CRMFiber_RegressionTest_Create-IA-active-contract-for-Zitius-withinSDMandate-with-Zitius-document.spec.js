...
test('TC003_CRMFiber_RegressionTest_Create-IA-active-contract-for-Zitius-withinSDMandate-with-Zitius-document', async function ({ browser }) {
  ...
  LocalTestData.set("OrderunderlagType", "PartialOrderunderlag");
