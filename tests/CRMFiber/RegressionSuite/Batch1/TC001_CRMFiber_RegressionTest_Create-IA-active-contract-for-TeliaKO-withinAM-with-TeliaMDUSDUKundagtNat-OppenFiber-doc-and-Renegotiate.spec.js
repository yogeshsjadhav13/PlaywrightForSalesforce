...
test('TC001_CRMFiber_RegressionTest_Create-IA-active-contract-for-TeliaKO-withinAMMandate-with-TeliaMDUSDUKundagtNat-OppenFiber-document-and-Renegotiate', async function ({ browser }) {
  ...
  LocalTestData.set("DiscountPercentage", 0.09);
