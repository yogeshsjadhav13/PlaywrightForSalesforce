...
const TestCaseName = 'TC001_CRMFiber_SanityTest';



test('TC001_CRMFiber_SanityTest_Create-IA-active-contract-for-TeliaKO-with-Telia-MDU-SDUKundagtNat-XLAN-document-and-Renegotiate', async function ({ browser }) {
