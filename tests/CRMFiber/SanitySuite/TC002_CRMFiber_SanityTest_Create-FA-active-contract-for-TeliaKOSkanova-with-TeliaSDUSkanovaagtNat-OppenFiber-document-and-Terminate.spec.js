...
const TestCaseName = 'TC002_CRMFiber_SanityTest';



test('TC002_CRMFiber_SanityTest_Create-FA-active-contract-for-TeliaKOSkanova-with-Telia-TeliaSDUSkanovaagtNat-OppenFiber-document-and-Terminate', async function ({ browser }) {
