...
const TestCaseName = 'TC022_SalesEnabler_RegressionTest';


test.skip('TC022_SalesEnabler_RegressionTest_Verify-creation-of-SME-Efterregistrering-opp-from-account-for-SOHO', async function ({ browser }) {
