...
const TestCaseName = 'TC021_SalesEnabler_RegressionTest';


test('TC021_SalesEnabler_RegressionTest_Verify-creation-of-Affarshmolighet-opp-from-account-for-SOHO', async function ({ browser }) {
