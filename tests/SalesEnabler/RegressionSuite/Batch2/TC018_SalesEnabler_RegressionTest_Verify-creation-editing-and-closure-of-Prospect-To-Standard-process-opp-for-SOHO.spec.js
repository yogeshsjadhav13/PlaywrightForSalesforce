...
const TestCaseName = 'TC018_SalesEnabler_RegressionTest';


test.skip('TC018_SalesEnabler_RegressionTest_Verify-creation-editing-and-closure-of-Prospect-To-Standard-process-opp-for-SOHO', async function ({ browser }) {
  ...
  //Step 4 - Create Prospect and convert to standard process Opportunity
  ...
  await page.locator("//li[text()='Vid omförhandling (CS) måste alltid Intäktseffekt kalkyl fyllas i.']").click();
  await page.getByRole('button', { name: 'Avbryt' }).first().click();
