...
const TestCaseName = 'TC007_SalesEnabler_RegressionTest';


test.skip('TC007_SalesEnabler_RegressionTest_Verify-creation-of-Prospect-To-Forenklad-process-opp-from-account-for-SME', async function ({ browser }) {
