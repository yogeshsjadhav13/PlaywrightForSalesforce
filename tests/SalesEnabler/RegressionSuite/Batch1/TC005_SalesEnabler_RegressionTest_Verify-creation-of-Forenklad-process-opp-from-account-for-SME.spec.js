...
const TestCaseName = 'TC005_SalesEnabler_RegressionTest';


test('TC005_SalesEnabler_RegressionTest_Verify-creation-of-Forenklad-process-opp-from-account-for-SME', async function ({ browser }) {
