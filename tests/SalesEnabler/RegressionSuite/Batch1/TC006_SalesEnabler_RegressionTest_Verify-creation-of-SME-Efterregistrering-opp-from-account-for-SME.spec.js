...
const TestCaseName = 'TC006_SalesEnabler_RegressionTest';


test('TC006_SalesEnabler_RegressionTest_Verify-creation-of-SME-Efterregistrering-opp-from-account-for-SME', async function ({ browser }) {
