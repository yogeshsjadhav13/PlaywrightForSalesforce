...
const TestCaseName = 'TC008_SalesEnabler_RegressionTest';


test.skip('TC008_SalesEnabler_RegressionTest_Verify-creation-of-Prospect-To-Standard-process-opp-from-account-for-SME', async function ({ browser }) {
