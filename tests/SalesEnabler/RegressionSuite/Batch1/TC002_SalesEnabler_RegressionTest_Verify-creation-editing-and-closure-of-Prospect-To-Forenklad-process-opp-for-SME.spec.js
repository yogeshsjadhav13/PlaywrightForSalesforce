...
const TestCaseName = 'TC002_SalesEnabler_RegressionTest';


test.skip('TC002_SalesEnabler_RegressionTest_Verify-creation-editing-and-closure-of-Prospect-To-Forenklad-process-opp-for-SME', async function ({ browser }) {
  ...
  await page.getByRole('button', { name: 'Konvertera till förenklad' }).click();
