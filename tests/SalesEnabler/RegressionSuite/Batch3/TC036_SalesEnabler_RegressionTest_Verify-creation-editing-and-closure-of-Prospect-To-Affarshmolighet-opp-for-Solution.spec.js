...
const TestCaseName = 'TC036_SalesEnabler_RegressionTest';


test('TC036_SalesEnabler_RegressionTest_Verify-creation-editing-and-closure-of-Prospect-To-Affarshmolighet-opp-for-Solution', async function ({ browser }) {
  ...
  await page.locator("//a[contains(normalize-space(.),'Konvertera till affärsmöjlighet')]").click();
