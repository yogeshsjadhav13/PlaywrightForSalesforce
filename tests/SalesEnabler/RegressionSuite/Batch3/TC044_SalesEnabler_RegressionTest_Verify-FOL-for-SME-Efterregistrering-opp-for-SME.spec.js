...
const TestCaseName = 'TC044_SalesEnabler_RegressionTest';


test('TC044_SalesEnabler_RegressionTest_Verify-FOL-for-SME-Efterregistrering-opp-for-SME', async function ({ browser }) {
  ...
  LocalTestData.set("SalesValueAmount", "0 kr");
