...
const TestCaseName = 'TC038_SalesEnabler_RegressionTest';


test('TC038_SalesEnabler_RegressionTest_Verify-creation-of-Affarshmolighet-opp-from-account-for-Solution', async function ({ browser }) {
