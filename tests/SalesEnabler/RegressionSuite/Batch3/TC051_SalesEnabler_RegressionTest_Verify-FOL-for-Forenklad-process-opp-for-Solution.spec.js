...
const TestCaseName = 'TC051_SalesEnabler_RegressionTest';


test('TC051_SalesEnabler_RegressionTest_Verify-FOL-for-Forenklad-process-opp-for-Solution', async function ({ browser }) {
