...
const TestCaseName = 'TC041_SalesEnabler_RegressionTest';


test('TC041_SalesEnabler_RegressionTest_Verify-creation-of-Prospect-To-Standard-process-opp-from-account-for-Solution', async function ({ browser }) {
