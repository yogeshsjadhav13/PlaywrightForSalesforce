...
const TestCaseName = 'TC047_SalesEnabler_RegressionTest';


test('TC047_SalesEnabler_RegressionTest_Verify-FOL-for-Standard-process-opp-for-SOHO', async function ({ browser }) {
  ...
  await page.locator("//records-record-layout-row//button[contains(normalize-space(.),'Redigera Nuvarande avtalsvärde CS (12 mån)')]").click();
  await page.locator("//label[contains(normalize-space(.),'Nuvarande avtalsvärde CS (12 mån)')]//following-sibling::div/input").fill("100");
  await page.locator("//records-form-footer//button[normalize-space(.)='Spara']").click();
  await page.locator("//div[contains(@class,'active') and contains(@class,'window')]//span[text()='Återförsäljare']//..//..//..//lightning-formatted-text[text()='Nej']").click();
  ...
  LocalTestData.set("Probability", "50 %");
  LocalTestData.set("WeightedNewSalesAmount", "122 kr");
  LocalTestData.set("WeightedContinuationSalesAmount", "122 kr");
  LocalTestData.set("UppsidaNewSales", "122 kr");
  LocalTestData.set("UppsidaContinuationSales", "122 kr");
