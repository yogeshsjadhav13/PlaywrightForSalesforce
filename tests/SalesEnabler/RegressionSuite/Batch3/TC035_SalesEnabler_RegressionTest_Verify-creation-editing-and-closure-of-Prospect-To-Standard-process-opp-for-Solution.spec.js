...
const TestCaseName = 'TC035_SalesEnabler_RegressionTest';


test('TC035_SalesEnabler_RegressionTest_Verify-creation-editing-and-closure-of-Prospect-To-Standard-process-opp-for-Solution', async function ({ browser }) {
  ...
  await opportunityPage.changeOpportunityStatus("Sluta avtal", "Avbruten");
