...
const TestCaseName = 'TC065_SalesEnabler_RegressionTest';


test('TC065_SalesEnabler_RegressionTest_Verify-Teliaavtal-contract-creation-for-SOHO-user', async function ({ browser }) {
