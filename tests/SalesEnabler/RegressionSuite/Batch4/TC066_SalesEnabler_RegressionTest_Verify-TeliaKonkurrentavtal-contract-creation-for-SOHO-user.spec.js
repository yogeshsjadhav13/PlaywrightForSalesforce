...
const TestCaseName = 'TC066_SalesEnabler_RegressionTest';


test('TC066_SalesEnabler_RegressionTest_Verify-TeliaKonkurrentavtal-contract-creation-for-SOHO-user', async function ({ browser }) {
