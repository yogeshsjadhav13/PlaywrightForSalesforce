...
const TestCaseName = 'TC068_SalesEnabler_RegressionTest';


test('TC068_SalesEnabler_RegressionTest_Verify-creation-of-HW-Affarshmolighet-opp-from-account-for-Device-Sales-Manager', async function ({ browser }) {
