...
const TestCaseName = 'TC053_SalesEnabler_RegressionTest';


test.skip('TC053_SalesEnabler_RegressionTest_Verify-Lead-To-Affarsmojlighet-Opportunity-converison-for-Large', async function ({ browser }) {
