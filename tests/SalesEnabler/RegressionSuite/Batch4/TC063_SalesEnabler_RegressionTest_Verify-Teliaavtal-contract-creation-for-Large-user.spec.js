...
const TestCaseName = 'TC063_SalesEnabler_RegressionTest';


test('TC063_SalesEnabler_RegressionTest_Verify-Teliaavtal-contract-creation-for-Large-user', async function ({ browser }) {
