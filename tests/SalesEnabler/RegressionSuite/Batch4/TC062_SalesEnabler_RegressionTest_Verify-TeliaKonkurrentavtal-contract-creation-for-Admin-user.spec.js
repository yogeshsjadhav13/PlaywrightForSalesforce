...
const TestCaseName = 'TC062_SalesEnabler_RegressionTest';


test('TC062_SalesEnabler_RegressionTest_Verify-TeliaKonkurrentavtal-contract-creation-for-Admin-user', async function ({ browser }) {
