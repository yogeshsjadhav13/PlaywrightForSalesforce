...
const TestCaseName = 'TC067_SalesEnabler_RegressionTest';


test('TC067_SalesEnabler_RegressionTest_Verify-creation-editing-and-closure-of-HW-Affarshmolighet-opp-for-Sales-Device-Sales-Manager', async function ({ browser }) {
  ...
  await opportunityPage.changeOpportunityStatusAndVerifyError("Vunnen", "Ange vilken konkurrent och nuvarande avtalspart");
