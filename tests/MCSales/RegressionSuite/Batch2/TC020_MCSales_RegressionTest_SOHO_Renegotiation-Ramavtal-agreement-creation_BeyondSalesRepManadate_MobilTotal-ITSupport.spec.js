...
const TestCaseName = 'TC020_MCSales_RegressionTest';



test('TC020_MCSales_RegressionTest_SOHO_Renegotiation-Ramavtal-agreement-creation_BeyondSalesRepManadate_MobilTotal-ITSupport', async function ({ browser }) {
