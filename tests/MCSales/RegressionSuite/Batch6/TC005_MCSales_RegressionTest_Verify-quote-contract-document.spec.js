...
const TestCaseName = 'TC005_MCSales_RegressionTest';


test('TC005_MCSales_RegressionTest_SOHO_NewSales-Verify-quote-contract-document', async function ({ browser }) {
  ...
  var M365EndDate = await utilityFunctionLocal.RunSOQLQuery("select TeliaSE_End_Date__c from vlocity_cmt__ContractLineItem__c where vlocity_cmt__ContractId__c = '"+ContractID+"' and Name = 'Microsoft 365'");
...
DoNotUse_PlaywrightTestAccount 71895
...
Med Telia IT-avdelning erbjuder vi ett tryggt IT-serviceavtal för en fungerande och säker IT-miljö. Vi har ett dedikerat team med olika kompetenser för att möta alla era behov och ge er en snabb och personlig IT-support.

Er egen IT-avdelning 

Både strategisk och operativ

Med Telia IT-avdelning får ert företag både strategiskt och operativt stöd. Som grund arbetar vi varje år fram hur er IT-miljö bör utvecklas och anpassas i takt med er verksamhets nuvarande och kommande behov. Detta dokumenterar vi ned i en gemensam IT-plan med nuläge, behov och lösningsförslag som vi följer upp och genomför under året. Denna plan är viktig både för ert företag och för oss så att vi tillsammans gör er ännu effektivare och konkurrenskraftiga. 

Årligt framtagande av IT-plan ingår i Avtalet. 

Vi kan som tillägg erbjuda strategiskt ledningsstöd på den nivå ni behöver det.

Operativt arbetar vi löpande med att hålla er IT-miljö uppdaterad, säker och tillgänglig. Genom att installera agenter på era uppkopplade enheter så kan vi erbjuda en proaktiv och automatiserad managering av er IT-miljö. Fyra gånger per år gör vi även en servicekontroll så att ni alltid kan ha koll på att vi managerar det som ni faktiskt använder. 

Snabb och kompetent IT support

Med Telia IT-avdelning får ni full tillgång till vår kunniga och serviceinriktade Support som hjälper er när ni behöver det som mest. När ni kontaktar oss är det precis som att ni kontaktar er IT-avdelning på kontoret, ni får snabb hjälp oavsett vad ärendet gäller, vi har kontakt med era tredjepartsleverantörer för att både säkerställa drift men även felsökningar.

Vår Support är redo att påbörja felavhjälpning på befintlig IT-miljö och alla tilläggstjänster enligt avtal inom 2 timmar från det att vi fått ärendet till oss via någon av våra kanaler (mail, telefon eller direkt via vår supportklient på era användares datorer). Med vårt IT-avdelning serviceavtal betalar ni en fast månadsavgift för all support och slipper tänka på oförutsedda kostnader.

Våra supporttekniker har olika expertkompetenser vilket gör att ert företag får tillgång till ett helt team med dedikerade resurser. Nästan all support kan vi lösa online men behövs det så kommer vi ut på plats för att lösa aktuellt ärende. 

Servicetid är helgfria vardagar kl 8:00-17:30.

Ert IT-serviceavtal

Telia IT-avdelning är ett IT-serviceavtal baserat på antal tjänster, användare och enheter (för de delar i IT-miljön som ingår i avtalet). 

Omfattning:

Uppstartsprojekt (inventering samt installation av användare och enheter)

Strategisk planering och rekommendationer för utveckling av IT-miljön och uppföljning med årlig IT-plan

Ni tilldelas en Technical Account Manager, er IT-rådgivare

Fri tillgång till support.

Proaktiv monitorering och managering.

Så här fungerar det när ni blir kund

För att det ska bli så enkelt som möjligt att komma igång så har vi färdiga processer och rutiner för uppstart av nya kunder. Ni får en dedicerad resurs från oss som ansvarar för hela er uppstart.
...
Avslutningsvis så har vi ett möte med en servicekontroll för att stämma av er faktiska IT-miljö.
...
Vi erbjuder dig som kund olika tjänster kopplat till era behov. Vi fungerar som ett bollplank och kommer rekommendera er de tjänster som er verksamhet behöver, tillsammans sätter vi planen för att alltid hålla er IT-miljö aktuell och säker. 
...
SLA Premium - responstid 1 timme

Utbildning 

Våra utbildningar möjliggör smarta och säkra arbetssätt för ert företag och personal

Microsoft Teams - Under vår utbildning förklarar vi fördelarna med Teams och hur ni arbetar effektivt tillsammans i kanaler, chattar och möten oavsett om ni är samlade på kontoret eller arbetar på distans. 

Microsoft Office 365 - Vår utbildning inom Office 365 omfattar utöver de vanligaste funktionerna som mail, kalender och kontakter även OneDrive, mobilappar, och säkerhet.
...
Prislista Telia IT-support Premium – IT-avdelning
...
TELIA IT-AVDELNING (Avtalstid: 36 månader)
...
Uppstart av dator och användare*



Installation av dator som köpts via Telia
...
Installation av dator som kunden köpt själv
...
Ominstallation befintlig dator och byte av användare
...
Installation och konfiguration av dator.

Uppläggning av användarkonton i de system och lösningar som Telia IT-avdelning managerar (nya användare).

Konfiguration av mail i dator samt i mobilen

Användargenomgång via telefon (önskas genomgång på plats kan detta beställas till och debitering sker enligt timpris för avtalad support på plats).
...
Utbildning för kunder med Telia IT-avdelning (per användare)
...
I avgiften för Tjänsten ingår support och managering för de användare, enheter och tjänster som Kunden avtalat om och arbete som utförs vardagar klockan 8:00 – 17:30. Tillkommande arbete som utförs och som ej ingår i den fasta avgiften debiteras enligt nedan timpris.
...
Tillkommande Supportärenden, IT-rådgivning och projekt
...
Total avgift Telia IT-avdelning
...
MÅNADSAVGIFT TELIA IT-AVDELNING
...
TELIA MICROSOFT 365, 12 MÅNADER BINDNINGSTID (Antal för basnivå: 30)
...
Microsoft migrering e-post, max 1 domän och 3 konton
...
Tillkommande migreringsavgift per mailkonto
...
Grundkonfiguration MS365, max 1 domän och 20 konton
...
TELIA SLUTANVÄNDARSUPPORT (Antal för basnivå: 30, Avtalstid: 36 månader)
...
SLUTANVÄNDARSUPPORT – 1:A LINJE MOBILT
...
Välkommen till 
Telia
Ramavtal för DoNotUse_PlaywrightTestAccount 71895 tjänster hos Telia
...
Jobbmobil 50 GB0 kr312 kr
Jobbmobil Obegränsad0 kr459 kr
...
i MyBusiness15kr/månad
Abonnemangsunika tillvalstjänster
TjänstJobbmobil 30-50 GBJobbmobil 80-ObegränsadJobbmobil Obegränsad Plus
Ej vald i avtalet
Surf i utlandet149 kr/månad149 kr/månad- kr/månad
Samtal i utlandet149 kr/månad149 kr/månad- kr/månad
Maxhastighet 
1500Mbit/s
65 kr/månad65 kr/månad0 kr/månad
...
Telia Microsoft 365
Tjänstespecifik avtalstid${ContractStartDate} – ${M365EndDate}
Volymåtagande30
Särskilda villkorEj tillämplig
Version av TjänstebeskrivningFör Funktionsbeskrivning (klicka här
7
) v.2.0
Telias ordinarie pris följer Microsofts riktpriser för Microsoft-abonnemang, vilket innebär att 
priset kan justeras upp eller ner under avtalstid om Microsoft ändrar sin prissättning.
AbonnemangBindningstidErt prisRabatt på 
månadsavgift
Microsoft 365 Business Basic12 månader62 kr6 %
Microsoft 365 Business Standard12 månader130 kr6 %
Microsoft 365 Business Premium12 månader228 kr6 %
Fotnoter Telia Microsoft 365
1.Business Basic, Premium och Standard gäller för företag 1-300 användare
2.Bindningstid ”Annual” är 12 månader.
3.Uppsägning/förändring ska ske senast 3 månader innan ny förnyelseperiod. Bindningstid “Monthly” är 30 dagar.
4.Uppsägning/förändring sker innan ny månad startar. 
5.Uppsägning, sänka antal eller nedgradering av produkter kan endast ske inom 24 timmar från orderläggning.
6.Eventuell rabatt är angiven som en procentuell rabattsats av ordinarie pris vid startdatumet för avtalet och därefter under nedan specificerad 
avtalstid.
7.https://www.telia.se/dam/jcr:20b601f3-732b-4af6-8dac-e9106acb82b0/Funktionsbeskrivning-Telia-Office-365 
Telias ordinarie pris följer Microsofts riktpriser för Microsoft-abonnemang, vilket innebär att priset kan justeras upp eller ner under avtalstid om 
Microsoft ändrar sin prissättning.
Microsoft Product Terms: https://www.microsoft.com/licensing/docs/view/Licensing-Use-Rights
...
Telia Slutanvändarsupport
Särskilda villkorFör 1:a linje Mobil-och Microsoftsupport avtalas ett volymåtagande på 
ett antal enheter under den tjänstespecifika avtalstiden. Kunden ska 
förse Telia med information om antalet enheter ökar under den 
tjänstespecifika avtalstiden. Om Kunden överskrider avtalat antal 
enheter debiteras överstigande enheter separat. 
Telia Slutanvändarsupport – 1:a linje mobilsupport
Tjänstespecifik avtalstid${ContractStartDate} – ${ContractEndDate}
VolymåtagandeAntal enheter: 30
Version av 
Tjänstebeskrivning
För Funktionsbeskrivning (klicka här
1
...
Antal enheterEngångsavgiftAvgift per enhetMånadsavgift
308 625 kr35 kr/månad1 077 kr
Fotnoter 1:a linje mobilsupport
1.https://www.telia.se/dam/jcr:1d39c04a-c78b-4c8a-be8f-c4de87104298/Funktionsbeskrivning-TELIA-F%C3%96RSTA-LINJE-MOBIL-
SLUTANV%C3%84NDARSUPPORT 
2.https://www.telia.se/dam/jcr:ec092652-8c01-421b-a7a2-f119f86f3d52/Tjanstespecifikation-TELIA-1ST-LINE-MOBIL-SLUTANVANDARSUPPORT
3.https://www.telia.se/dam/jcr:860e57f2-e9ee-44ef-9d13-3ed501b39a09/Detaljerad-Tj%C3%A4nstebeskrivning-TELIA-F%C3%96RSTA-LINJE-
MOBIL-SLUTANV%C3%84NDARSUPPORT
4.https://creativehub.teliacompany.com/m/310213e603c977a9/original/Avtalsmall-TechSverige.pdf
...
(tjänster på användarnivå 
och företagsnivå)
Ett belopp om 1800 kr (beräknat enligt #${FAQuoteNumber})
...
Tjänster på användarnivå
Användare IT-avdelning360 kr
Tjänster på företagsnivå
Serviceavgift IT-avdelning4 000 kr
Managering Server IT-avdelning1 500 kr
Managering Nätverksenhet IT-avdelning60 kr
Support och manageringMånadsavgift
Antivirus IT-avdelning20 kr
M365 Cloud Backup IT-avdelning35 kr
Google Cloud Backup IT-avdelning35 kr
Premium SLA 1 timme IT-avdelning5 000 kr
...
I avgiften för Tjänsten ingår support och managering för de användare, enheter och tjänster som Kunden 
avtalat om och arbete som utförs vardagar klockan 8:00 – 17:30. Tillkommande arbete som utförs och som
ej ingår i den fasta avgiften debiteras enligt nedan timpris.
Tillkommande supportärenden, IT-rådgivning och projektAvgift
Support (Tekniker)800 kr/timme
Support (Senior Tekniker)1 000 kr/timme
Projekt (Migreringar, nyinstallationer, flytt eller upstart av nytt kontor etc.1 000 kr/timme
Strategiskt ledningsstöd1 200 kr/timme
Fotnoter Telia IT Support Premium – Telia IT-avdelning
...
Kundens organisationsnummer: 5599993077
...
Tjänster på användarnivå
Användare IT-avdelning5360 kr1 800 kr 
Tilläggstjänster
Antivirus IT-avdelning520 kr100 kr 
SAMMANSTÄLLNING
VOLYMÅTAGANDE
(tjänster på användarnivå och företagsnivå)
1 800 kr
TOTAL MÅNADSAVGIFT 1 900 kr
Telia Microsoft 365
Leveranstid 
Vid beställning av Microsoft tjänster från Telia kommer licenserna att aktiveras på 
överenskommen dag enligt avtal. Pris utgår från Microsofts prislista på aktiveringsdagen. 
Priser
...
Månads-
avgift
 TELIA MICROSOFT 365, 12 MÅNADER BINDNINGSTID
Microsoft 365 Business Basic50 kr62 kr
Microsoft 365 Business Standard50 kr130 kr
Microsoft 365 Business Premium50 kr228 kr
Microsoft 365 - Övriga Tjänster
Microsoft migrering e-post, max 1 domän 
och 3 konton
54 999 kr0 kr 
Tillkommande migreringsavgift per 
mailkonto
5399 kr0 kr 
Grundkonfiguration MS365, max 1 domän 
och 20 konton
53 999 kr0 kr 
Summa46 985 kr2 100 kr
KOMMENTARSAMMANSTÄLLNING
TOTAL ENGÅNGSAVGIFT46 985 kr
Totala engångsavgiften visar den 
faktiska kostnaden efter avdragen 
engångsavgift.
TOTAL MÅNADSAVGIFT2 100 kr 
