...
test('TC010_MCSales_RegressionTest_SOHO_NewSales-Verify-quote-contract-document', async function ({ browser }) {
  ...
  var OpportunityID = await utilityFunctionLocal.RunSOQLQuery("select vlocity_cmt__OpportunityId__c from contract where AccountId ='" + AccountID + "' and (Status != 'Cancelled')");
...
DoNotUse_PlaywrightTestAccount 83999
...
Nedan beskriver vi några av de behov vi har identifierat i vår dialog med er. Efter uppstart kommer vi att ha en helhetsbild av er verksamhet och kan då föreslå ytterligare förbättringsområden och möjligheter kopplade till er IT-miljö.

Några identifierade behov är: 

Ni söker en samarbetspartner som kan supportera er gemensamma telekom och IT-miljö. Ni söker hjälp för enheter såsom mobiltelefon, dator eller surfplatta men även hjälp med IT-tjänster såsom Microsoft 365.

Att er partner är experter inom Microsoft är viktigt för er då ni har behov av admin support för Microsoft för att hantera företagets alla konton. Ni efterfrågar även rådgivning kring vilka licenser som passar era behov. 

Utöver ovan behöver ni även hjälp med gemensamma enheter såsom router, brandvägg, switch, wifi-access punkter, skrivare och scanners – det som behövs för att hålla igång er IT-miljö helt enkelt. 

Genom att överlåta IT-strul till experter ser ni att ni kan få mer tid över till er verksamhet och på det sättet bli mer produktiva. Ni vill kunna lita på att få svar inom en förutbestämd tid som samtidigt håller hög kvalité. 

Ni önskar en tydlig och fast månadskostnad utan överraskande fakturor med ett fast pris per användare, oavsett hur många ärenden ni behöver hjälp med. Dessutom vill ni kunna skala upp eller ner beroende på hur många anställda ni har. Vid behov vill ni även kunna köpa IT-relaterad hårdvara via er support. 

Er partner ska kunna driva IT-projekt och hjälpa till med strategisk IT och informationssäkerhet.

Allt ovan ser vi mycket fram emot att hjälpa er med som kund hos oss!

Telia IT-support Plus

Med Telia IT-support Plus så får ni både en slutanvändarsupport och support till era administratörer på era gemensamma system, enheter och nätverk samt centrala delar i Microsoft 365 och Telias övriga tjänster. Ni får tillgång till ett helt expertteam som är redo att ge er full support och ser till att både användarnas och företagets gemensamma IT fungerar som det ska.

Problem datorer eller uppkopplingar skapar frustration och leder dessutom till att ert företag förlorar produktivitet. Låt en IT-tekniker från Telia hjälpa er med IT-frågorna, det spelar ingen roll om det handlar om Telias tjänster eller tjänster från andra leverantörer.

Vi hjälper er att nyttja Microsoft 365 och Teams fullt ut, vilket möjliggör ett mer effektivt och digitaliserat arbetssätt. Med stöd från Telias IT-tekniker kan säkerheten och produktiviteten öka hos era medarbetare.
...
Prislista Telia IT-support Plus
...
TELIA IT-SUPPORT PLUS (Antal för basnivå: 70, Avtalstid: 36 månader)
...
Windows Server Support Online (per server)
...
Tillkommande supportavgifter



Supportärende online till kundens medarbetare som inte är registrerad användare i IT-serviceavtalet. Support online för enhet eller tjänster som inte ingår i IT-serviceavtalet och enstaka installationer av ny dator
...
Supportärende på plats för ärenden som inte kan lösas online
...
IT-Projekt (förändringsarbeten, migreringar och implementering av nya tjänster)
...
Total avgift Telia IT-support Plus
...
MÅNADSAVGIFT TELIA IT-SUPPORT PLUS
...
SLUTANVÄNDARSUPPORT – 2:A LINJE MOBILT
...
SLUTANVÄNDARSUPPORT – 2:A LINJE MICROSOFT 365
...
SLUTANVÄNDARSUPPORT – 1:A LINJE MICROSOFT 365
...
Välkommen till 
Telia
Ramavtal för DoNotUse_PlaywrightTestAccount 83999 tjänster hos Telia
...
För 2:a linje Mobil-och Microsoftsupport avtalas ett volymåtagande på 
ett antal ärenden per år. Om Kunden överskrider avtalat antal ärenden 
debiteras överstigande ärenden separat.
...
Telia Slutanvändarsupport – 2:a linje mobilsupport
Tjänstespecifik avtalstid${ContractStartDate} – ${ContractEndDate}
VolymåtagandeAntal ärenden: 400 per år
Version av 
Tjänstebeskrivning
För Funktionsbeskrivning (klicka här
1
...
Antal ärendenEngångsavgiftAvgift per ärendeMånadsavgift
4005 750 kr340 kr/månad11 349 kr
Fotnoter 2:a linje mobilsupport
1.https://www.telia.se/dam/jcr:1d39c04a-c78b-4c8a-be8f-c4de87104298/Funktionsbeskrivning-TELIA-F%C3%96RSTA-LINJE-MOBIL-
SLUTANV%C3%84NDARSUPPORT 
2.https://www.telia.se/dam/jcr:ec092652-8c01-421b-a7a2-f119f86f3d52/Tjanstespecifikation-TELIA-1ST-LINE-MOBIL-SLUTANVANDARSUPPORT
3.https://www.telia.se/dam/jcr:860e57f2-e9ee-44ef-9d13-3ed501b39a09/Detaljerad-Tj%C3%A4nstebeskrivning-TELIA-F%C3%96RSTA-LINJE-
MOBIL-SLUTANV%C3%84NDARSUPPORT
4.https://creativehub.teliacompany.com/m/310213e603c977a9/original/Avtalsmall-TechSverige.pdf 
Telia Slutanvändarsupport – 1:a linje Microsoftsupport
...
Antal enheterEngångsavgiftAvgift per enhetMånadsavgift
308 625 kr178 kr/månad5 354 kr
Fotnoter 1:a linje Microsoftsupport
1.https://www.telia.se/dam/jcr:408c8a87-2c2e-499b-b613-c727216f0ed5/Funktionsbeskrivning-TELIA-F%C3%96RSTA-LINJE-MICROSOFT-
SLUTANV%C3%84NDARSUPPORT
2.https://www.telia.se/dam/jcr:1a6e09c8-2d54-47c9-a9f8-95f323ce86a4/Tjanstespecifikation-TELIA-1ST-LINE-MICROSOFT-
SLUTANVANDARSUPPORT
3.https://www.telia.se/dam/jcr:8edaf727-147a-4748-b43f-9d79c6a74721/Detaljerad-Tj%C3%A4nstebeskrivning-TELIA F%C3%96RSTA-LINJE-
MICROSOFT-SLUTANV%C3%84NDARSUPPORT
4.https://creativehub.teliacompany.com/m/310213e603c977a9/original/Avtalsmall-TechSverige.pdf 
Telia slutanvändarsupport – 2:a linje Microsoftsupport
Tjänstespecifik avtalstid${ContractStartDate} – ${ContractEndDate}
VolymåtagandeAntal ärenden: 400 per år
Version av 
Tjänstebeskrivning
...
Antal ärendenEngångsavgiftAvgift per ärendeMånadsavgift
4005 750 kr340 kr/månad11 349 kr
Fotnoter 2:a linje Microsoftsupport
1.https://www.telia.se/dam/jcr:1d39c04a-c78b-4c8a-be8f-c4de87104298/Funktionsbeskrivning-TELIA-F%C3%96RSTA-LINJE-MOBIL-
SLUTANV%C3%84NDARSUPPORT
2.https://www.telia.se/dam/jcr:ec092652-8c01-421b-a7a2-f119f86f3d52/Tjanstespecifikation-TELIA-1ST-LINE-MOBIL-SLUTANVANDARSUPPORT
3.https://www.telia.se/dam/jcr:860e57f2-e9ee-44ef-9d13-3ed501b39a09/Detaljerad-Tj%C3%A4nstebeskrivning-TELIA-F%C3%96RSTA-LINJE-
...
Telia IT-support Plus
Tjänstespecifik avtalstid${ContractStartDate} – ${ContractEndDate}
Avtalat leveransdatum${ContractStartDate}
Volymåtagande
(tjänster på användarnivå och 
företagsnivå)
Ett belopp om 1120 kr (beräknat enligt #${FAQuoteNumber})
...
Kunden åtar sig att under den tjänstespecifika avtalstiden betala minst 75% 
av volymåtagandet. Telia äger rätt att tilläggsdebitera mellanskillnaden för 
...
Tjänsten kan månadsavgiften bli lägre än 75% av volymåtagandet. I sådant 
fall kommer ingen tilläggsdebitering av mellanskillnaden att ske. 
Telia äger rätten att, i förekommande fall, neka avropsberättigade bolag 
support om dessa bolag inte uppfyller de krav på Kundens IT-miljö som 
anges i Tjänstebeskrivningent.
Version av 
Tjänstebeskrivning
För Funktionsbeskrivning (klicka här
3
...
Telia IT-support PlusMånadsavgift
Användare
1
Användare IT-support Plus224 kr
TilläggstjänsterMånadsavgift
Windows Server Support Online (per server)1 000 kr
Tillkommande avgifter
I avgiften för Tjänsten ingår support för de användare som Kunden avtalat om. Tillkommande arbete som 
utförs och som ej ingår i den fasta avgiften debiteras enligt nedan timpris.
Tillkommande supportAvgift
Supportärende online till kundens medarbetare som inte är registrerad användare i 
IT-serviceavtalet. Support online för enhet eller tjänster som inte ingår i IT-
serviceavtalet och enstaka installationer av ny dator
800 kr/timme
Supportärende på plats för ärenden som inte kan lösas online
2
900 kr/timme
IT-Projekt (förändringsarbeten,  migreringar och implementering av nya tjänster)
1 100 kr/timme
Fotnoter IT-support Plus
1.Användare avser i detta fall en registrerad användare som ingår i IT-serviceavtalet. I användaravgiften ingår slutanvändarsupport online.
1.Minimidebitering för support online är 30 minuter och support på plats är 60 minuter.
2.https://creativehub.teliacompany.com/m/128f16fc9836fab5/original/Funktionsbeskrivning-IT-support-Plus.pdf
3.https://creativehub.teliacompany.com/m/458e90e3e40a55b5/original/Tjanstespecifikation-Telia-IT-support-PLUS.pdf 
4.IT-tjänster Allmänna bestämmelser, TechSverige, - https://creativehub.teliacompany.com/m/310213e603c977a9/original/Avtalsmall-
TechSverige.pdf  
...
Kundens organisationsnummer: 5599950085
...
Tjänster på användarnivå
Användare IT-support Plus5224 kr1 120 kr 
Tilläggstjänster
Windows Server Support Online (per server)51 000 kr5 000 kr 
SAMMANSTÄLLNING
VOLYMÅTAGANDE
(tjänster på användarnivå och företagsnivå)
1 120 kr
TOTAL MÅNADSAVGIFT 6 120 kr
