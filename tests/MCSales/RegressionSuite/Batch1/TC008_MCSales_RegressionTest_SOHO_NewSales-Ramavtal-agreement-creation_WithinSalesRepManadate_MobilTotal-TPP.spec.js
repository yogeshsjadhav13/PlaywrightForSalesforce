...
const TestCaseName = 'TC008_MCSales_RegressionTest';



test('TC008_MCSales_RegressionTest_SOHO_NewSales-Ramavtal-agreement-creation_WithinSalesRepManadate_MobilTotal-TPP', async function ({ browser }) {
