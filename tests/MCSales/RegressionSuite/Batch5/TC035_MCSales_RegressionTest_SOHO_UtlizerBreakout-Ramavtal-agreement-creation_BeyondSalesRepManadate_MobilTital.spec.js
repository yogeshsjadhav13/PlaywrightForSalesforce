...
const TestCaseName = 'TC035_MCSales_RegressionTest';



test('TC035_MCSales_RegressionTest_SOHO_UtlizerBreakout-Ramavtal-agreement-creation_BeyondSalesRepManadate_MobilTital', async function ({ browser }) {
  ...
  LocalTestData.set("UtilizerBreakoutContractStatus", "Active");
