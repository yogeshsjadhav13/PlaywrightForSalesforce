...
test('TC036_MCSales_RegressionTest_SOHO_Inforhandling-Ramavtal-agreement-creation_WithinSalesRepManadate_MobilTotal', async function ({ browser }) {
  ...
  //await quotePage.skapaAvtalMCSalesFlowIdentifierInforhandling.click();
