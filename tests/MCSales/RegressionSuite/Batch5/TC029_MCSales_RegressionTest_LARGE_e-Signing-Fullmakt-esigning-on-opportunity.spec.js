...
const TestCaseName = 'TC029_MCSales_RegressionTest';



test('TC029_MCSales_RegressionTest_LARGE_e-Signing-Fullmakt-esigning-on-opportunity', async function ({ browser }) {
