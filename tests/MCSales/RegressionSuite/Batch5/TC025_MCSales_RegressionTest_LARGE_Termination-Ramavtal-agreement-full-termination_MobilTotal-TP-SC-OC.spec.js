...
const TestCaseName = 'TC025_MCSales_RegressionTest';



test('TC025_MCSales_RegressionTest_LARGE_Termination-Ramavtal-agreement-full-termination_MobilTotal-SC', async function ({ browser }) {
