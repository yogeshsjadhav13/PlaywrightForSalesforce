...
const TestCaseName = 'TC030_MCSales_RegressionTest';



test('TC030_MCSales_RegressionTest_SOHO_e-Signing-Fullmakt-esigning-on-account', async function ({ browser }) {
  ...
  await opportunityPage.performEsigningOnAccount(LocalTestData, utilityFunctionLocal);
