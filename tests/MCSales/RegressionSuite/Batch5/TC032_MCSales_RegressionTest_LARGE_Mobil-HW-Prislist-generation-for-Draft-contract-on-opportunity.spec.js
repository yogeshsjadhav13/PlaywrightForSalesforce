...
const TestCaseName = 'TC032_MCSales_RegressionTest';



test.skip('TC032_MCSales_RegressionTest_LARGE_Mobil-HW-Prislist-generation-for-Draft-contract-on-opportunity', async function ({ browser }) {
  ...
  await opportunityPage.performMobilHWPrislistForContractOnOpportunity(LocalTestData, utilityFunctionLocal);
