...
test('TC039_MCSales_RegressionTest_SOHO_Tilläggsförhandling-Ramavtal-agreement-creation_BeyondSalesRepManadate_MobilTotal-O365-TP-BBPro', async function ({ browser }) {
  ...
  var subProductName1 = "Fast användare";
  var subProductName2 = "Servicenummer";
  ...
  await faCartPage.cartFrame.locator("//span[normalize-space(.)='" + ProductName + "']//ancestor::div[@class='cpq-product-cart-item']//div[@class='cpq-item-no-children' and @ng-class and text()='" + subProductName1 + "']//ancestor::div[@class='cpq-item-base-product']//child::div[5]//child::div[1]//child::div[contains(@ng-if,'TeliaSE_Approved_Price__c') and contains(normalize-space(.),'33')]").click();
  await faCartPage.cartFrame.locator("//span[normalize-space(.)='" + ProductName + "']//ancestor::div[@class='cpq-product-cart-item']//div[@class='cpq-item-no-children' and @ng-class and text()='" + subProductName2 + "']//ancestor::div[@class='cpq-item-base-product']//child::div[5]//child::div[1]//child::div[contains(@ng-if,'TeliaSE_Approved_Price__c') and contains(normalize-space(.),'87')]").click();
