...
const TestCaseName = 'TC045_MCSales_RegressionTest';



test('TC045_MCSales_RegressionTest_LARGE_NewSales-Ramavtal-agreement-creation_BeyondSalesRepManadate_MobilTotal-BBStart-Datanet-CloudVPNLan-TP', async function ({ browser }) {
