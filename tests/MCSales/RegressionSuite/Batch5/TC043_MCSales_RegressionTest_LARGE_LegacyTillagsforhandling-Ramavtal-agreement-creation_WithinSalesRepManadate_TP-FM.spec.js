...
const TestCaseName = 'TC043_MCSales_RegressionTest';



test('TC043_MCSales_RegressionTest_LARGE_LegacyTillagsforhandling-Ramavtal-agreement-creation_WithinSalesRepManadate_TP-FM', async function ({ browser }) {
  ...
  if (LocalTestData.get("SalesFlowType") === "Renegotiation" || (LocalTestData.get("SalesFlowType") === "LegacyNegotiation" && LocalTestData.get("LegacyNegotiation") === "LegacyOmforhandling")) {
