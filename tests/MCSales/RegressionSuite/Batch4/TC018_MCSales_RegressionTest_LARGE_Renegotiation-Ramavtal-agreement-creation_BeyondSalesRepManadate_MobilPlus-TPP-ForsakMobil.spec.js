...
const TestCaseName = 'TC018_MCSales_RegressionTest';



test('TC018_MCSales_RegressionTest_LARGE_Renegotiation-Ramavtal-agreement-creation_BeyondSalesRepManadate_MobilPlus-TPP-ForsakringMobil', async function ({ browser }) {
