...
const TestCaseName = 'TC016_MCSales_RegressionTest';



test('TC016_MCSales_RegressionTest_LARGE_NewSales-Ramavtal-agreement-creation_WithinSalesRepManadate_MobilTotal-SC', async function ({ browser }) {
  ...
  //Verify error message for Operator connect
  var ProductName = "Mobilupplägg All-IN+";
  LocalTestData.set("Products", ProductName);
  LocalTestData.set("DiscountPercentage", 1);
  await faCartPage.AddProductToTheCart(LocalTestData);
  await faCartPage.ConfigureMCSalesProductInTheCart(LocalTestData);
  await faCartPage.cartNollstallOffertkvantitetButton.click();
  await page.waitForTimeout(5000);
  await faCartPage.cartFrame.locator("//span[@class='cpq-product-name' and text()='" + ProductName + "']").click();
  await faCartPage.toggleSubOffersInProduct(ProductName, "Kluster LARGE");
  await expect(faCartPage.cartFrame.locator("//span[normalize-space(.)='" + ProductName + "']//ancestor::div[@class='cpq-product-cart-item']//div[@class='cpq-item-no-children' and @ng-class and text()='" + LocalTestData.get("MobilupplaggAllInPlusSubProducts") + "']//..//..//..//div[contains(@ng-if, 'FACallOffQuantity')]//input")).toHaveValue("");
  await faCartPage.cartValideraVarukorgenButton.click();
  await faCartPage.cartFrame.locator("//div[@class='cpq-product-cart-item']//div[@class='cpq-item-no-children' and @ng-class and text()='" + LocalTestData.get("MobilupplaggAllInPlusSubProducts") + "']//..//..//..//img[contains(@src,'Sad')]").first().click();
  await faCartPage.cartStangKonfiguration.click();
  await quotePage.quoteKonfigureraButton.click();
  await faCartPage.cartFrame.locator("//span[@class='cpq-product-name' and text()='" + ProductName + "']").click();
  await faCartPage.toggleSubOffersInProduct(ProductName, "Kluster LARGE");
  await faCartPage.cartFrame.locator("//div[@class='cpq-product-cart-item']//div[@class='cpq-item-no-children' and @ng-class and text()='" + LocalTestData.get("MobilupplaggAllInPlusSubProducts") + "']//..//..//..//img[contains(@src,'Sad')]").first().click();
  LocalTestData.set("DiscountPercentage", 0);
  await faCartPage.cartStangKonfiguration.click();
  await quotePage.quoteKonfigureraButton.click();
  await faCartPage.cartFrame.locator("//span[@class='cpq-product-name' and text()='" + ProductName + "']").click();
  await faCartPage.toggleSubOffersInProduct(ProductName, "Kluster LARGE");
  await faCartPage.cartFrame.locator("//span[normalize-space(.)='" + ProductName + "']//ancestor::div[@class='cpq-product-cart-item']//div[@class='cpq-item-no-children' and @ng-class and text()='" + LocalTestData.get("MobilupplaggAllInPlusSubProducts") + "']//ancestor::div[@class='cpq-item-base-product']//child::div[4]//child::div[1]//child::div[contains(@ng-if,'TeliaSE_Approved_Price__c')]").click();
  const MalPris = await faCartPage.cartFrame.locator("//span[normalize-space(.)='" + ProductName + "']//ancestor::div[@class='cpq-product-cart-item']//div[@class='cpq-item-no-children' and @ng-class and text()='" + LocalTestData.get("MobilupplaggAllInPlusSubProducts") + "']//ancestor::div[@class='cpq-item-base-product']//child::div[4]//child::div[1]//child::div[contains(@ng-if,'TeliaSE_Approved_Price__c')]").textContent();
  const OnskatPris = Math.round(MalPris - (MalPris * (LocalTestData.get("DiscountPercentage"))));
  await faCartPage.cartFrame.locator("//span[normalize-space(.)='" + ProductName + "']//ancestor::div[@class='cpq-product-cart-item']//div[@class='cpq-item-no-children' and @ng-class and text()='" + LocalTestData.get("MobilupplaggAllInPlusSubProducts") + "']//..//..//..//div[contains(@ng-if, 'Requested_Price')]//input").click();
  await faCartPage.cartFrame.locator("//span[normalize-space(.)='" + ProductName + "']//ancestor::div[@class='cpq-product-cart-item']//div[@class='cpq-item-no-children' and @ng-class and text()='" + LocalTestData.get("MobilupplaggAllInPlusSubProducts") + "']//..//..//..//div[contains(@ng-if, 'Requested_Price')]//input").clear();
  await faCartPage.cartFrame.locator("//span[normalize-space(.)='" + ProductName + "']//ancestor::div[@class='cpq-product-cart-item']//div[@class='cpq-item-no-children' and @ng-class and text()='" + LocalTestData.get("MobilupplaggAllInPlusSubProducts") + "']//..//..//..//div[contains(@ng-if, 'Requested_Price')]//input").type((OnskatPris).toString());
  ...
  await quotePage.quoteKonfigureraButton.click();
  await quotePage.cartSkapaOffertdokumentButton.click();
  await expect(faCartPage.cartSkapaOffertDokumentErrorMessage).toContainText('Du kan inte skapa en offert utan produktkvantitet');
