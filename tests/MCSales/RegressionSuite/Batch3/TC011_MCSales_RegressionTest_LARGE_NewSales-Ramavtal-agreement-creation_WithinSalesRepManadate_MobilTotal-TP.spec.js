...
const TestCaseName = 'TC011_MCSales_RegressionTest';



test('TC011_MCSales_RegressionTest_LARGE_NewSales-Ramavtal-agreement-creation_WithinSalesRepManadate_MobilTotal-TP', async function ({ browser }) {
  ...
  LocalTestData.set("NoQuantityForTP", "Yes");
