...
const TestCaseName = 'TC001_MCSales_PerformanceTest';


test('TC001_MCSales_PerformanceTest_SOHO_NewSales-Ramavtal-agreement-creation-within-sales-rep-mandate_MobilTotal-BBPlus', async function ({ browser }) {
