...
const TestCaseName = 'TC006_MCSales_SanityTest_PerformanceTest';


test('TC006_MCSales_SanityTest_LARGE_PerformanceTest_NewSales-Ramavtal-agreement-creation-within-sales-rep-mandate_MobilTotal-SC-TPP', async function ({ browser }) {
